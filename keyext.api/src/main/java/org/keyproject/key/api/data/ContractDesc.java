 ...
 *
 * Contracts can be arbitrary objects, representing a functional, dependency, information flow, etc. contract.
...
public record ContractDesc(KeyIdentifications.ContractId contractId, String name,
        String displayName, String typeName, String htmlText, String plainText) implements KeYDataTransferObject {
