...
//        }		
        ...
        assert GenInstrumentData.getInstance().isInitialized;
        ...
        sb.append("   HashMap<String, ArrayList<Integer>> traces = genInstrument.callGenInstrument(inputVars);");
        sb.append(NEW_LINE);
...
//        }		
    ...
    private void copyFiles(final String srcName, final String targName)
        ...
        if (srcFile.isDirectory()) {
            ...
            //FIXME DANIEL BETTER
            final File targFile = new File(targDir, "GenTest.java");
...
//                    + " public class " + className + " implements IGeneratedTest"
                    ...
                    + "   return new junit.framework.JUnit4TestAdapter("+"GenTest"+".class);" + NEW_LINE 
                    + " } " + NEW_LINE 
                    + NEW_LINE + " public " + "GenTest" + "(){}" + NEW_LINE + NEW_LINE;
        } else {
            res += 	"import dynacode.DynaCode;\n" + 
            		...
            		"import java.util.HashMap;\n"
            		+ "public class " + "GenTest" + " implements IGenTest " + "{ " + NEW_LINE 
...
//        res.append(" public static void  main (java.lang.String[]  arg) {" + NEW_LINE
        res.append("public HashMap<String, ArrayList<Integer>> callGenTest(){" + NEW_LINE
                + "   " + "GenTest" + " testSuiteObject;" + NEW_LINE
                + "   testSuiteObject=new " + "GenTest" + " ();" + NEW_LINE + NEW_LINE);
        for (int j = 0; j < i; j++) {
  ...
  //Daniel: modified - fixed path for generated Tests
