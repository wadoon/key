...
public class Main {
	...
	public static InvGenResult attemptInvGen(SequentWrapper sequent, boolean firstCall) {
		...
		if (firstCall) {
			...
			//       M�glich: In Klasse ArrayLists f�r die Variablen anlegen, und in den generierten Code die Zwischenwerte den ArrayLists hinzuf�gen
			//				  Danach sogar ohne Reflection m�glich darauf zuzugreifen
	...
	public static String getExecuteableJavaCodeFromKeYFormat(StatementBlock program, Term update) {
		...
		// Und local Variables mit Assignment um deren Anfangs-Zuweisungen zum Programm zu erg�nzen (fehlt in StatementBlock)
