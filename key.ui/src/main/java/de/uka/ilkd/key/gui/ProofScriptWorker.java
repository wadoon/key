...
public class ProofScriptWorker extends SwingWorker<@Nullable Object, ProofScriptEngine.Message>
    ...
    public ProofScriptWorker(KeYMediator mediator, KeyAst.ProofScriptEntry script) {
     ...
     */
    public ProofScriptWorker(KeYMediator mediator, KeyAst.ProofScriptEntry script, @Nullable Goal initiallySelectedGoal) {
    ...
    public void done() {
        ...
        final Proof proof = initiallySelectedGoal != null
                ? initiallySelectedGoal.proof()
                : mediator.getSelectedProof();
