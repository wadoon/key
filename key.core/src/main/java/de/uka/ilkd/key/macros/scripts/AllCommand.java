...
public class AllCommand implements ProofScriptCommand<Map<String, Object>> {
    ...
    @Override
    public void execute(AbstractUserInterfaceControl uiControl, Map<String, Object> args, EngineState stateMap) throws ScriptException, InterruptedException {
        var block = (KeYParser.ProofScriptContext) args.get(ParsedCommand.KEY_SUB_SCRIPT);
        ...
        for (Goal g : proof.openGoals()) {
            ...
            stateMap.setGoal(g);
            stateMap.getEngine().execute(uiControl, proof, block.proofScriptCommand());
            // }
        }
