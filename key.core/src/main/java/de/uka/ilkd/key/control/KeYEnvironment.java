...
public class KeYEnvironment<U extends UserInterfaceControl> {
     ...
     */
    private final KeyAst.@Nullable ProofScriptEntry proofScript;
    ...
    public KeYEnvironment(U ui, InitConfig initConfig, Proof loadedProof,
                          KeyAst.@Nullable ProofScriptEntry proofScript, ReplayResult replayResult) {
        this.ui = ui;
    ...
    /**
     * Returns an entry for the proof script if present.
     */
