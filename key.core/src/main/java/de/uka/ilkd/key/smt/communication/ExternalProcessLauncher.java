...
public class ExternalProcessLauncher {
    ...
    /**
     * the solver type of the solver that is launched by this launcher
     */
    private final @Nonnull SolverType type;
     ...
     * @param type              solver type that is launched by this launcher
     */
