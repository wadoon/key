 ...
 */
public class KeYEnvironment<S extends IServices, IC extends InitConfig<S,IC>, U extends UserInterface<S, IC>> {
   /**
    ...
    */
   public KeYEnvironment(U ui, IC initConfig) {
    ...
    * @param initConfig The loaded project.
    */
   public KeYEnvironment(U ui, IC initConfig, Proof loadedProof) {
      this.ui = ui;
    ...
    */
   public ISpecificationRepository getSpecificationRepository() {
   ...
   public static KeYEnvironment <?, ?, UserInterface<?, ?>> loadInMainWindow(File location,
      ...
      return new KeYEnvironment(main.getUserInterface(), initConfig, loader.getProof());
   }
    ...
    * @throws ProblemLoaderException Occurred Exception
    */
   public static KeYEnvironment<Services, JavaDLInitConfig, CustomConsoleUserInterface> load(File location,
                                                                 List<File> classPaths,
                                                                 File bootClassPath) throws ProblemLoaderException {
      CustomConsoleUserInterface ui = new CustomConsoleUserInterface(false);
      DefaultJavaDLProblemLoader loader = (DefaultJavaDLProblemLoader) ui.load(location, classPaths, bootClassPath);
