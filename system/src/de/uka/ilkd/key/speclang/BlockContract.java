...
public interface BlockContract extends SpecificationElement {
    ...
    public boolean isReadOnly(IServices services);
    /**
    ...
    public Term getPrecondition(LocationVariable heapVariable,
                                ...
                                IServices services);
    public Term getPrecondition(LocationVariable heap, IServices services);

    public Term getPostcondition(LocationVariable heap, Variables variables, IServices services);
    public Term getPostcondition(LocationVariable heapVariable, Term heap, Terms terms, IServices services);
    public Term getPostcondition(LocationVariable heap, IServices services);

    public Term getModifiesClause(LocationVariable heap, ProgramVariable self, IServices services);
    public Term getModifiesClause(LocationVariable heapVariable, Term heap, Term self, IServices services);
    public Term getModifiesClause(LocationVariable heap, IServices services);
    ...
    public static class Variables {
        ...
        public static Variables create(final StatementBlock block, final List<Label> labels, final IProgramMethod method, final IServices services)
        {
        ...
        {
            if (variable != null) {
                return JavaDLTermBuilder.DF.var(variable);
            }
            else {
                return null;
            }
    ...
    public static class VariablesCreator extends JavaDLTermBuilder.Serviced {
        ...
        public VariablesCreator(final StatementBlock block, final List<Label> labels, final IProgramMethod method, final IServices services)
        {
