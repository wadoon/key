...
public final class SimpleBlockContract implements BlockContract {
    ...
    @Override
    public boolean isReadOnly(final IServices services)
    {
    ...
    @Override
    public Term getPrecondition(final LocationVariable heap, final IServices services)
    {
        return getPrecondition(heap, variables.self, variables.remembranceHeaps, services);
    }

    @Override
    public Term getPostcondition(final LocationVariable heap, final Variables variables, final IServices services)
    {
        assert heap != null;
    ...
    @Override
    public Term getPostcondition(final LocationVariable heapVariable, final Term heap, final Terms terms, final IServices services)
    {
        assert heapVariable != null;
        assert heap != null;
        assert terms != null;
    ...
    @Override
    public Term getPostcondition(final LocationVariable heap, final IServices services)
    {
        return getPostcondition(heap, variables, services);
    }

    @Override
    public Term getModifiesClause(final LocationVariable heap, final ProgramVariable self, final IServices services)
    {
        assert heap != null;
        assert (self == null) == (variables.self == null);
        assert services != null;
    ...
    @Override
    public Term getModifiesClause(final LocationVariable heapVariable, final Term heap, final Term self, final IServices services)
    {
        assert heapVariable != null;
        assert heap != null;
        assert (self == null) == (variables.self == null);
    ...
    @Override
    public Term getModifiesClause(final LocationVariable heap, final IServices services)
    {
    ...
    @Override
    public String getHtmlText(final IServices services)
    {
        assert services != null;
        // TODO Clean up.
    ...
    private Map<ProgramVariable, ProgramVariable> createReplacementMap(final Variables newVariables, final IServices services)
    {
    ...
    private Map<Term, Term> createReplacementMap(final Term newHeap, final Terms newTerms, final IServices services)
    {
    ...
    private static class TermReplacementMap extends ReplacementMap<Term> {
        ...
        public void replaceHeap(final Term newHeap, final IServices services)
        {
            assert newHeap != null;
    ...
    public static final class Creator extends JavaDLTermBuilder.Serviced {
    ...
    private static final class Combinator extends JavaDLTermBuilder.Serviced {
