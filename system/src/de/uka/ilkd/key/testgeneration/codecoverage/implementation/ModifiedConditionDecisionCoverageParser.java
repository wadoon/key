 ...
 * {@link IExecutionNode} instances, and return a subset of those nodes based on some criteria.
 * <p>
 * The common use of such parsers in KeYTestGen is to guarantee a certain degree of code coverage
 * for the code being tested. The returned set of nodes will in this case form a basis for a test
 * suite which will satisfy the targeted code coverage criteria.
 * 
 * @author christopher
 */
