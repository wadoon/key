...
public abstract class Op implements java.io.Serializable {
  ...
  public interface Visitor <R,A> {
    public R visit(de.uka.ilkd.key.testgeneration.parser.z3parser.tree.bnf.Absyn.SNeg p, A arg);
    public R visit(de.uka.ilkd.key.testgeneration.parser.z3parser.tree.bnf.Absyn.SPos p, A arg);
