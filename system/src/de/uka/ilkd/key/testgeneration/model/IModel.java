 ...
 * cause the execution of a specific test case to have a specific effect, such as taking a desired
 * execution path. In particular, it represents a set of values which will satisfy a path condition
 * for a given part of a symbolic execution tree.
 * 
 * @author christopher
 */
