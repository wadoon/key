...
public abstract class AbstractTermParser {
    ...
    protected static String resolveIdentifierString(Term term) {
        ...
        /*
         * Base case 1: underlying definition is a LocationVariable and hence does not consist of
         * any more nested recursions, so we just extract the current variable name and go back.
         */
        ...
        /*
         * Base case 2: underlying definition is a Function, and hence either represents the
         * symbolic heap or the root object instance ("self"). In this case we also cannot go any
         * further. We are not interested in the symbolic heap here, so we simply return the root
         * name.
         */
