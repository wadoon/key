...
import de.uka.ilkd.key.testgeneration.core.parsers.visitors.TermXMLVisitor;
import de.uka.ilkd.key.testgeneration.core.parsers.visitors.XMLVisitorException;

/**
 * Provides the logic needed in order to parse the {@link Term} postcondition of
 * a method, turning it into an equivalent XML representation.
 * 
 * @author christopher
 */
public enum OracleGenerator {
    ...
    /**
     * Extracts the postconditon for the root method call in a symbolic
     * execution tree as a {@link Term}. The postcondition will be formatted in
     * order to remove state information generated by KeY, which is not
     * necessary for the purpose of generating an actual test oracle.
     * {@link Term}.
     * 
     * @param root
     ...
     *             in the event that the method cannot be found, or something
     *             went wrong with regard to extracting the postcondition.
     * @throws XMLVisitorException
     *             if an error occured during the visitation
     */
    ...
    /**
     * {@link Visitor} over {@link Term} objects, used for the purpose of
     * translating a Term into a more abstract XML representation.
     * 
     * @author christopher
     */
