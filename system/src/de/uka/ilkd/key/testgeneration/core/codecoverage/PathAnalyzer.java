package de.uka.ilkd.key.testgeneration.core.codecoverage;
...
/**
 * Encapsultates logic needed to achieve code coverage for a given symbolic
 * execution tree.
 * 
 * @author christopher
 */
public class PathAnalyzer {
     ...
     * @return
     */
    public List<IExecutionNode> getStatementCoveringNodes(
     ...
     * @return
     */
    public List<IExecutionNode> getDecisionCoveringNodes(
            IExecutionStartNode root) {
     ...
     * <code>c < d</code>. Thus in order to satisfy Condition Coverage for this
     ...
     * @return
     */
    public List<IExecutionNode> getConditionCoveringNodes(
            IExecutionStartNode root) {
