...
import de.uka.ilkd.key.testgeneration.core.classabstraction.KeYJavaClassFactory;
...
public enum CoreInterface {
    ...
    public List<TestSuite> createTestSuites(final String path,
        ...
        for (final String method : methods) {
            ...
            final TestSuite testSuite = createTestSuite(keYJavaClass,
    ...
    private List<TestCase> createTestCasesForMethod(
        ...
        try {
             ...
             * contracts.
             */
            oracle = oracleProcessor.createOracleForMethod(method);
