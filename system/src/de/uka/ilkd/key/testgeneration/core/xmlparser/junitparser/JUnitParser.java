...
/**
 * Instances of this class are used in order to create JUnit4 test suites from
 * the internal XML representation generated by KeYTestGen2.
 * 
 * @author christopher
 */
public class JUnitParser extends XMLHandler implements ITestCaseParser<String> {
    ...
    public String generateTestCaseFromXML(String representation)
        ...
        try {
            ...
            JUnitMediator result = new JUnitGenerationWorker(representation)
                    .generateJUnitTestSuite();
    ...
    private static class JUnitGenerationWorker {
        ...
        public JUnitGenerationWorker(String xmlDocument)
        ...
        public JUnitMediator generateJUnitTestSuite() throws XMLStreamException {
            ...
            /*
             * The main parse loop. Identify the nature of each XML element, and
             * its corresponding XML subtree accordingly.
             */
            while (eventReader.hasNext()) {
                ...
                /*
                 * Select only elements corresponding to opening tags, i.e.
                 * <testcase>, <method> etc. Other elements will form elements
                 * of these primary components, and are handled by methods
                 * specific to such components.
                 */
        ...
        /**
         * Processes an XML subtree corresponding to a test case. A test case
        ...
        private void processTestCase() throws XMLStreamException {
            ...
            /*
             * Create a new instance of TestMethod, which will encapsulate all
             * JUnit statements generated by this method as well as its helpers.
             */
        ...
        /**
         * Processes an XML subtree corresponding to a method definition. The
         * method described here will be a single method in the the original
         * Java file for which we will be generating a test case.
         * 
         * @param testMethod
         * @throws XMLStreamException
         */
        ...
        /**
         * Given that the stream pointer in the {@link XMLEventReader} is
         * currently pointing to the start of an XML subtree of the form:
         * 
         * <pre>
         * {@literal <name>}
         *      Some name
         ...
         * </pre>
         * 
         * this method return the name enclosed between the tags, and moves the
         * stream pointer to the end of the subtree.
         * 
         * @return the name
         * @throws XMLStreamException
         */
         ...
         * </pre>
         * 
         * this method will extract and return the identifier for each such
         * parameter. The parameters are prefixed by "this." in order to avoid
         * name clashes.
         * 
         ...
         * </pre>
         * 
         * this method constructs a context mapping between instances of
         * {@link ObjectVariable} and {@link ObjectInstance} instances,
         * representing a set of variable declarations and the actual object
         * instances they point to (if any).
         * 
         ...
         * </pre>
         * 
         * this method will extract an {@link ObjectVariable} instance for each
         * variable, and return a list of these.
         * 
         * @param testCaseMediator
        ...
        private void extractVariables(TestCaseMediator testCaseMediator)
            ...
            /*
             * Extract all variables, stop when the </variables> tag is
             * encountered, and discard it.
             */
            while (!eventReader.nextTag().isEndElement()) {

                ObjectVariable variable = extractVariable();
                testCaseMediator
                        .addVariable(variable.getIdentifier(), variable);
            }
            eventReader.nextTag();
         ...
         * </pre>
         * 
         * this method constructs an {@link ObjectVariable} instance the
         * variable represented in this XML subtree.
         * 
        ...
        private ObjectVariable extractVariable() throws XMLStreamException {
             ...
             */
            eventReader.nextTag();
            String identifier = eventReader.nextEvent().asCharacters()
                    .getData().trim();
            eventReader.nextTag();
             ...
             */
            eventReader.nextTag();
            String type = eventReader.nextEvent().asCharacters().getData()
                    .trim();
            eventReader.nextTag();
             ...
             */
            eventReader.nextTag();
            String reference = eventReader.nextEvent().asCharacters().getData()
                    .trim();
            eventReader.nextTag();
         ...
         * </pre>
         * 
         * this method will extract an {@link ObjectInstance} instance for each
         * variable, and return a list of these.
         * 
         * @param testCaseMediator
         * @return a list of {@link ObjectInstance} instances
         * @throws XMLStreamException
         */
        private List<ObjectInstance> extractInstances(
                TestCaseMediator testCaseMediator) throws XMLStreamException {
            ...
            while (!eventReader.nextTag().isEndElement()) {
                ...
                testCaseMediator
                        .addInstance(instance.getIdentifier(), instance);
            }
            eventReader.nextTag();
        ...
        private ObjectInstance extractInstance(TestCaseMediator testCaseMediator)
            ...
            /*
             * Extract the field identifiers of this instance, and map each
             * field to an ObjectVariabel instance.
             */
         ...
         * </pre>
         * 
         * this method will extract the identifier for each field, and return a
         * list of these.
         * 
         * @return a list of variable identifiers.
         * @throws XMLStreamException
         */
        private List<String> extractFieldIdentifiers()
                throws XMLStreamException {
    ...
    /**
     * Mediating class which encapsulates JUnit data generated during the
     * parsing of an XML test suite.
     * 
     * @author christopher
     */
