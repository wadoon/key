...
public class KTGCommandLineInterface {
    ...
    private static void printHelp() {
        System.out.println("Usage: \n" +
                INDENT + "ktg2 [options] [framework] source | directory \n");

    }

    private static void printOptions() {
        System.out.println("Options: \n " +
                INDENT + "-o, --output-dir \t directory to put the generated test cases \n" +
                INDENT + "-b, --batch  directory \t create test cases for all sources in directory");
    }
