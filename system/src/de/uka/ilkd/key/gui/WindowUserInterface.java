...
public class WindowUserInterface extends AbstractWindowUserInterface<Services, JavaDLInitConfig> {
	...
	@Override
	public void proofCreated(AbstractProblemInitializer<Services, JavaDLInitConfig> sender,
	...
	public void taskFinished(TaskFinishedInfo info) {
		if (info.getSource() instanceof ApplyStrategy) {
			resetStatus(this);
			ApplyStrategy.ApplyStrategyInfo result = (ApplyStrategy.ApplyStrategyInfo) info
			        .getResult();
	...
	@Override
	public ProblemInitializer createProblemInitializer(boolean b) {
