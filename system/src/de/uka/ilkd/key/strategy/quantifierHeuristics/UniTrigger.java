...
class UniTrigger implements Trigger {
    ...
    private ImmutableSet<Substitution> getSubstitutionsFromTerm(Term t, IServices services) {
    ...
    private ImmutableSet<Substitution> getSubstitutionsFromTermHelp(Term t, IServices services) {
