...
public class NamespaceSet {
	...
	private Namespace<ParsableVariable> varNS = new Namespace<ParsableVariable>();
	private Namespace<IProgramVariable> progVarNS = new Namespace<IProgramVariable>();
	private Namespace<SortedOperator> funcNS = new Namespace<SortedOperator>();
	...
	public NamespaceSet(Namespace<ParsableVariable> varNS,
			Namespace<SortedOperator> funcNS, Namespace<Sort> sortNS,
	...
	public Namespace<ParsableVariable> variables() {
		return varNS;
	}

	public void setVariables(Namespace<ParsableVariable> varNS) {
		this.varNS = varNS;
	}
	...
	public Namespace<SortedOperator> functions() {
		return funcNS;
	}

	public void setFunctions(Namespace<SortedOperator> funcNS) {
		this.funcNS = funcNS;
	}
	 ...
	 */
	private Namespace<? super Named>[] asArray() {
	...
	public void addProtocolled(NamespaceSet nss) {
		final Namespace<? super Named>[] myNames = asArray();
		final Namespace<? super Named>[] otherNames = nss.asArray();
		for (int i = 0; i < myNames.length; i++) {
			final Iterator<? extends Named> it = otherNames[i].getProtocolled();
			while (it.hasNext()) {
