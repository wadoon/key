 ...
 */
public class JavaDLInitConfig extends InitConfig<Services, JavaDLInitConfig> {
     ...
     */
    protected final ProofEnvironment<JavaDLInitConfig> env;
    ...
    public JavaDLInitConfig(Services services, Profile<Services, JavaDLInitConfig> profile) {
	super(profile);
        this.services  = services;
	this.env       = new ProofEnvironment<JavaDLInitConfig>(this);
     ...
     */
    @Override
    public ProofEnvironment<JavaDLInitConfig> getProofEnv() {
