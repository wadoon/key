...
public abstract class InitConfig<S extends IServices, IC extends InitConfig<S, IC>> {

    protected final Profile<S, IC> profile;

    public InitConfig(Profile<S,IC> profile) {
     ...
     */
    private HashMap<Taclet, TacletBuilder> taclet2Builder = new LinkedHashMap<Taclet, TacletBuilder>();
    /**
