...
public final class BooleanLDT extends LDT {
    ...
    @Override
    public boolean isResponsible
	(de.uka.ilkd.key.java.expression.Operator op, Term left, Term right, IServices services, ExecutionContext ec) {
	return false;
	...
	(de.uka.ilkd.key.java.expression.Operator op, IServices services, 
                ExecutionContext ec) {
	assert false;
	return null;
    }   
