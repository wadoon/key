...
public class SMTSolverResult {
     ...
     * TRUE iff negation of the sequent is unsatisfiable, FALSIFIABLE iff
     * negation of the sequent is satisfiable (i.e. it has a counterexample),
     * UNKNOWN otherwise (I'm not sure if this holds if an error occurs) Note:
     * Currently (1.12.'09) the SMT Solvers do not check if a node is FALSE.
     */
    ...
    // We should get rid of this constant because it does not track the source
    // (the solver) of the result.
    public static final SMTSolverResult NO_IDEA = new SMTSolverResult(
