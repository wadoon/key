...
public interface SMTTranslator {
     ...
     * <code>translate(Term t, IServices services)</code> is that assumptions
     * will be added.
     ...
     */
    public StringBuffer translateProblem(Term problem, IServices services,SMTSettings settings) 
           throws IllegalFormulaException;
