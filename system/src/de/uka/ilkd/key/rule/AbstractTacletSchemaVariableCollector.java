...
public abstract class AbstractTacletSchemaVariableCollector extends DefaultVisitor {

    /** collects all found variables */
    protected ImmutableList<SchemaVariable> varList;

    protected abstract ImmutableList<SchemaVariable> collectSVInProgram(Term t, ImmutableList<SchemaVariable> vars);

    protected abstract ImmutableList<SchemaVariable> collectSVInProgram(JavaBlock jb, ImmutableList<SchemaVariable> vars);
    ...
    public AbstractTacletSchemaVariableCollector() {
     ...
     */
    private ImmutableList<SchemaVariable> collectSVInElementaryUpdate(ElementaryUpdate op, ImmutableList<SchemaVariable> vars) {
    ...
    public void setSVInstantiations(SVInstantiations svInst) {
        this.instantiations = svInst;
    }
