...
public class BlockContractRule implements BuiltInRule {
    ...
    private static final TermBuilder TB = JavaDLTermBuilder.DF;
    ...
    public boolean isApplicable(final Goal goal, final PosInOccurrence occurrence)
    {
        ...
        final Instantiation instantiation =
                instantiate(occurrence.subTerm(), goal, (Services) goal.proof().getServices());
        if (instantiation == null) {
            return false;
        }
        final ImmutableSet<BlockContract> contracts =
                getApplicableContracts(instantiation, goal, (Services) goal.proof().getServices());
    ...
    @Override
    public ImmutableList<Goal> apply(final Goal goal, final IServices services, final RuleApp application) throws RuleAbortException
    {
        assert application instanceof BlockContractBuiltInRuleApp;
        return apply(goal, (Services) services, (BlockContractBuiltInRuleApp) application);
    }
    ...
    private static final class UpdatesBuilder extends JavaDLTermBuilder.Serviced {
    ...
    private static final class ConditionsAndClausesBuilder extends JavaDLTermBuilder.Serviced {
