 ...
 */
public class ABSProgramContextAdder implements
        IProgramContextAdder<ABSStatementBlock> {
     ...
     */
    @Override
    public ABSStatementBlock start(NonTerminalProgramElement context,
            ABSStatementBlock putIn, ContextStatementBlockInstantiation ct) {

        return (ABSStatementBlock) wrap(context, putIn, ct.prefix().iterator(),
                ct.prefix().depth(), ct.prefix(), ct.suffix());
    }

    protected NonTerminalProgramElement wrap(NonTerminalProgramElement context,
            ABSStatementBlock putIn, IntIterator prefixPos, int prefixDepth,
            PosInProgram prefix, PosInProgram suffix) {
