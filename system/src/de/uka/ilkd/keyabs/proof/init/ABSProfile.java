...
public class ABSProfile extends AbstractProfile<ABSServices, ABSInitConfig> {
    ...
    @Override
    public ABSInitConfig createInitConfig(ABSServices services) {
        return new ABSInitConfig(services, this);
    }
