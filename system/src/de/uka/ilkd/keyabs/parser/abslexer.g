...
class ABSKeYLexer extends Lexer;
options {
    k=2;
...

{
    ...
    public ABSKeYLexer(InputStream in, KeYExceptionHandler keh){
        this(in);
	if(keh != null)
            this.keh = keh; 
    ...
    public ABSKeYLexer(Reader in, KeYExceptionHandler keh) {
