...
public class CCEquality extends DPLLAtom {
	...
	CCEquality(int assertionstacklevel, CCTerm c1, CCTerm c2) {
		super(HashUtils.hashJenkins(0, c1, c2), assertionstacklevel);
		this.m_lhs = c1;
		this.m_rhs = c2;
	...
	public Term getSMTFormula(Theory smtTheory, boolean useAuxVars) {
		Term lhs = m_lhs.toSMTTerm(smtTheory, useAuxVars);
		Term rhs = m_rhs.toSMTTerm(smtTheory, useAuxVars);
		return smtTheory.term(smtTheory.m_Equals, lhs, rhs);
	}
