...
public class AbstractSymbolicExecutionTestCase extends TestCase {
   ...
   /**
    * Searches a {@link IProgramMethod} in the given {@link IServices}.
    * @param services The {@link IServices} to search in.
   ...
   protected static SymbolicExecutionEnvironment<Services, JavaDLInitConfig, CustomConsoleUserInterface> createSymbolicExecutionEnvironment(File baseDir,
      ...
      // Load java file
      KeYEnvironment<Services, JavaDLInitConfig, CustomConsoleUserInterface> environment = KeYEnvironment.load(javaFile, null, null);
      // Start proof
      ...
      return new SymbolicExecutionEnvironment<Services, JavaDLInitConfig, CustomConsoleUserInterface>(environment, builder);
   }
   ...
   protected static SymbolicExecutionEnvironment<Services, JavaDLInitConfig, CustomConsoleUserInterface> createSymbolicExecutionEnvironment(File baseDir,
      ...
      // Load java file
      KeYEnvironment<Services, JavaDLInitConfig, CustomConsoleUserInterface> environment = KeYEnvironment.load(proofFile, null, null);
