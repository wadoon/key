...
public class TestSymbolicExecutionTreeBuilder extends AbstractSymbolicExecutionTestCase {
   ...
   protected void doTest(File baseDir,
      ...
      try {
         ...
         SymbolicExecutionEnvironment<Services, JavaDLInitConfig, CustomConsoleUserInterface> env = createSymbolicExecutionEnvironment(baseDir, javaPathInBaseDir, containerTypeName, methodFullName, null, mergeBranchConditions);
