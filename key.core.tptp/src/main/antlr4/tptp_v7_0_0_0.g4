/**
This file is part of KeY and was copied from
  https://github.com/TobiasScholl/TPTP-ANTLR4-Grammar/blob/master/
...
fof_binary_assoc        : fof_or_formula | fof_and_formula;
fof_or_formula          : fof_or_formula Or fof_unitary_formula
                        | fof_unitary_formula;
fof_and_formula         : fof_and_formula And fof_unitary_formula
                        | fof_unitary_formula;
fof_unitary_formula     : fof_quantified_formula | fof_unary_formula
                        | fof_atomic_formula | '(' fof_logic_formula ')';
