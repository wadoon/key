...
class NameRuleFilter implements RuleFilter {
    protected final HashSet<String> allowedRulesNames = new HashSet<>(32);
...
class SemanticsRuleFilter extends NameRuleFilter {
    public SemanticsRuleFilter() {
        ...
        //disabled: allowedRulesNames.add("applyEq");
    }
}

class EqualityRuleFilter extends NameRuleFilter {
    public EqualityRuleFilter() {
