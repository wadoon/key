 ...
 * numbers may be limited and cut off if superceded.
 */
...
public class Position {
     ...
     * 
     * @return <CODE>true</CODE>, if the given object is a position equals to
     ...
     * @return a negative number, zero, or a positive number, if this position
     *         is lower than, equals to, or higher than the given one.
     */
