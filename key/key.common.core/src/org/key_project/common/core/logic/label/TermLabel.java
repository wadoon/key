 ...
 * via {@link TermLabelManager#instantiateLabels(org.key_project.common.core.services.Services, de.uka.ilkd.key.logic.PosInOccurrence<JavaDLTerm, SequentFormula<JavaDLTerm>>, Term, de.uka.ilkd.key.rule.Rule, de.uka.ilkd.key.proof.Goal, Object, Term, de.uka.ilkd.key.logic.op.Operator, de.uka.ilkd.key.collection.ImmutableArray, de.uka.ilkd.key.collection.ImmutableArray, de.uka.ilkd.key.logic.JavaBlock)}
 * and of existing {@link Term}s are refactored (added or removed) via
 * {@link TermLabelManager#refactorGoal(org.key_project.common.core.services.Services, de.uka.ilkd.key.logic.PosInOccurrence<JavaDLTerm, SequentFormula<JavaDLTerm>>, Term, de.uka.ilkd.key.rule.Rule, de.uka.ilkd.key.proof.Goal, Term)}.
 * </p>
 * <p>
 ...
 * {@link TermLabelManager#mergeLabels(org.key_project.common.core.services.Services, de.uka.ilkd.key.logic.SequentChangeInfo)}
 ...
 *       {@link TermLabelManager#instantiateLabels(org.key_project.common.core.services.Services, de.uka.ilkd.key.logic.PosInOccurrence<JavaDLTerm, SequentFormula<JavaDLTerm>>, de.uka.ilkd.key.rule.Rule, de.uka.ilkd.key.proof.Goal, Object, Term, de.uka.ilkd.key.logic.op.Operator, de.uka.ilkd.key.collection.ImmutableArray, de.uka.ilkd.key.collection.ImmutableArray, de.uka.ilkd.key.logic.JavaBlock)} and
 *       {@link TermLabelManager#refactorLabels(org.key_project.common.core.services.Services, de.uka.ilkd.key.logic.PosInOccurrence<JavaDLTerm, SequentFormula<JavaDLTerm>>, de.uka.ilkd.key.rule.Rule, de.uka.ilkd.key.proof.Goal, Term)}
