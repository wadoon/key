 ...
 */
public abstract class CCWarySubstOp<V extends CCTermVisitor<T>, T extends CCTerm<V, T>> extends CCSubstOp<T> {
    ...
    public T apply(T term, TermServices services, Class<T> clazz) {
        ...
        WaryClashFreeSubst<V, T> cfSubst =
                new WaryClashFreeSubst<V, T>(v, term.sub(0), services, clazz);
