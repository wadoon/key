...
public class TacletAppComparator implements Comparator<TacletApp> {
     ...
     * depends on the depth of the term to be replaced. If no such term exists
     * we add a constant (may be refined in future). TODO finish comment
     * 
     * @param l
     * @return
     */
    ...
    /**
     * Rough approximation of the program complexity. TODO finish comment
     * 
     * @param b
     * @return
     */
