...
public final class StrategySelectionFX extends JPanel {
    ...
    /** Build everything */
    private void layoutPane(AutoModeActionFX autoModeAction) {
        ...
        if (!DEFINITION.getProperties().isEmpty()) {
            ...
            for (AbstractStrategyPropertyDefinition definition : DEFINITION.getProperties()) {
                yCoord = createStrategyProperty(components, FACTORY, javaDLOptionsPanel, javaDLOptionsLayout, yCoord,
                        true, definition);
            }
    ...
    protected int createStrategyProperty(StrategySelectionComponents data, StrategyFactory factory,
            JPanel javaDLOptionsPanel, GridBagLayout javaDLOptionsLayout, int yCoord, boolean topLevel,
        ...
        if (definition instanceof OneOfStrategyPropertyDefinition) {
            ...
            if (topLevel) {
                ...
                for (StrategyPropertyValueDefinition valueDefinition : oneOfDefinition.getValues()) {
                    gridx += 2;
                    JRadioButton radioButton = newButton(valueDefinition.getValue(), oneOfDefinition.getApiKey(),
                    ...
                    addJavaDLOption(javaDLOptionsPanel, radioButton, javaDLOptionsLayout,
                            valueDefinition.getSwingGridx() >= 0 ? valueDefinition.getSwingGridx() : gridx, yCoord,
        ...
        for (AbstractStrategyPropertyDefinition subProperty : definition.getSubProperties()) {
            yCoord = createStrategyProperty(data, factory, javaDLOptionsPanel, javaDLOptionsLayout, yCoord, false,
                    subProperty);
        }
        return yCoord;
    }

    private JRadioButton newButton(String text, final String key, final String command, boolean selected,
            boolean enabled, final StrategyFactory factory) {
    ...
    private void addJavaDLOptionSpace(JPanel javaDLOptionsPanel, GridBagLayout javaDLOptionsLayout, int yCoord) {
        ...
        addJavaDLOption(javaDLOptionsPanel, Box.createRigidArea(new Dimension(4, 4)), javaDLOptionsLayout, 0, yCoord,
                1);
        addJavaDLOption(javaDLOptionsPanel, Box.createRigidArea(new Dimension(4, 4)), javaDLOptionsLayout, 1, yCoord,
                1);
    }

    private void addJavaDLOption(JPanel javaDLOptionsPanel, Component widget, GridBagLayout javaDLOptionsLayout,
        ...
        defaultButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                mediator.getSelectedProof().getSettings().getStrategySettings()
                        .setMaxSteps(DEFINITION.getDefaultMaxRuleApplications());
    ...
    private void refreshDefaultButton() {
        if (mediator.getSelectedProof() != null) {
            ...
            boolean defaultProperties = getProperties()
                    .equals(DEFINITION.getDefaultPropertiesFactory().createDefaultStrategyProperties());
    ...
    private StrategyProperties getProperties() {
        ...
        for (Entry<String, ButtonGroup> entry : components.getPropertyGroups().entrySet()) {
            ...
            if (selected != null) {
                ...
                p.setProperty(entry.getKey(), DEFINITION.getDefaultPropertiesFactory().createDefaultStrategyProperties()
