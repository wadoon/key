...
public class CssFileHandler {
    ...
    /**
     * Constructs a CssFileHandler without file.
     * Call loadCssFile to add the file afterwards.
     */
     ...
     * @param url path to the css file
     * @throws IOException
     */
    ...
    /**
     * Returns a List of CssRules parsed from the css file. 
     * List will be empty if no file was loaded.
