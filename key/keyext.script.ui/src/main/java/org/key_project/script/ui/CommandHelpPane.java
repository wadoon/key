...
public class CommandHelpPane extends JPanel implements TabPanel {
    ...
    public CommandHelpPane(MainWindow window, KeYMediator mediator) {
        ...
        //TODO dl.getBuilders().add(new ProofScriptCommandBuilder(ProofScriptCommandApi.INSTANCE.getScriptCommands()));
        setCommandLookup(dl);
        ...
        ProofScriptCommandApi.INSTANCE.getScriptCommands().forEach(proofMacro -> {
