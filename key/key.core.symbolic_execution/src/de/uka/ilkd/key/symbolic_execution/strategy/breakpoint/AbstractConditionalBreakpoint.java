...
public abstract class AbstractConditionalBreakpoint extends AbstractHitCountBreakpoint {
   ...
   private Term computeTermForCondition(String condition) throws SLTranslationException {
      ...
      JavaInfo info = getProof().getServices().getProgramServices().getJavaInfo();
      ...
      for(KeYJavaType kjtloc: kjts){
         if (kjtloc.getProgramType() instanceof TypeDeclaration) {
            ImmutableList<Field> fields = info.getAllFields((TypeDeclaration)kjtloc.getProgramType());
