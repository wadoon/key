 ...
 * @version 1 (02.03.19)
 */
public class CommandHelpExtension implements KeYPaneExtension {
    private CommandHelpPane panel;

    @Override
    public void init(MainWindow window, KeYMediator mediator) {
        panel = new CommandHelpPane(window, mediator);
    }

    @Override
    public Icon getIcon() {
        return IconFontSwing.buildIcon(FontAwesomeBold.QUESTION_CIRCLE, 16);
    }
...
class CommandHelpPane extends JPanel {
