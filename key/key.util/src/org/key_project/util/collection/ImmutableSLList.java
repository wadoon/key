...
@SuppressWarnings("unchecked") public abstract class ImmutableSLList<T>
    ...
    public static <T> ImmutableSLList<T> singleton(T obj) {
        return (ImmutableSLList<T>) ImmutableSLList.<T>nil().prepend(obj);
    }

    /**
     * Reverses this list (O(N))
     */
    @Override public ImmutableList<T> reverse() {
        if (size() <= 1)
            return this;
     ...
     * Convert the list to a Java array (O(n))
     */
    @Override public <S> S[] toArray(Class<S> type) {
     ...
     */
    @Override public ImmutableList<T> prepend(T... array) {
    ...
    @Override public ImmutableList<T> append(Iterable<T> collection) {
    ...
    @Override public ImmutableList<T> prepend(Iterable<T> collection) {
        ImmutableList<T> tmp = this;
        for (T elem : collection) {
     ...
     */
    @Override public ImmutableList<T> take(int n) {
        if (n < 0 || n > size())
    ...
    private static class Cons<S> extends ImmutableSLList<S> {
         ...
         * @return IList<T> the new list
         */
        @Override public ImmutableList<S> prepend(S e) {
         ...
         * @return IList<T> the new list
         */
        @Override public ImmutableList<S> prepend(ImmutableList<S> list) {
            if (list.isEmpty()) {
                return this;
            }
         ...
         * @return IList<T> the new list
         */
        @Override public ImmutableList<S> append(S e) {
         ...
         * @return IList<T> the new list
         */
        @Override public ImmutableList<S> append(ImmutableList<S> list) {
         ...
         * @return IList<T> the new list
         */
        @Override public ImmutableList<S> append(S... array) {
         ...
         */
        @Override public ImmutableList<S> tail() {
            return cons;
        }
         ...
         */
        @Override public boolean contains(S obj) {
         ...
         * @return new list
         */
        @Override public ImmutableList<S> removeFirst(S obj) {
         ...
         * @return new list
         */
        @Override public ImmutableList<S> removeAll(S obj) {
            S[] res = (S[]) new Object[size()];
            int i = 0;
            ImmutableSLList<S> rest = this;
    ...
    private static class NIL<S> extends ImmutableSLList<S> {
        ...
        @Override public ImmutableList<S> prepend(S element) {
        ...
        @Override public ImmutableList<S> append(S element) {
            return new Cons<S>(element);
        }
