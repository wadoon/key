...
public abstract class ImmutableSLList<T> implements ImmutableList<T> {
    ...
    public ImmutableList<T> reverse() {
        ...
        ImmutableList<T> rev = KeYCollections.nil();
        while (!rest.isEmpty()) {
    ...
    static class Cons<S> extends ImmutableSLList<S> {
        ...
        public ImmutableList<S> append(S... array) {
            return ((ImmutableList<S>) KeYCollections.nil()).prepend(array).prepend(this);
        }
    ...
    static class ImmutableListCollector<T>
        ...
        public Function<List<T>, ImmutableList<T>> finisher() {
            return list -> KeYCollections.<T>nil().append(list);
        }
