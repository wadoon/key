...
public interface SolidityListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code specClassInvariant}
	 * labeled alternative in {@link SolidityParser#specExpression}.
	 * @param ctx the parse tree
	 */
	void enterSpecClassInvariant(SolidityParser.SpecClassInvariantContext ctx);
	/**
	 * Exit a parse tree produced by the {@code specClassInvariant}
	 * labeled alternative in {@link SolidityParser#specExpression}.
	 * @param ctx the parse tree
	 */
