...
public class SwingUtils {
	...
	public static void setSystemLookAndFeel() {
		...
		} catch (InstantiationException e2) {// ignore
		} catch (IllegalAccessException e3) {// ignore
	...
	public static class ThinLoweredBevelBorder extends javax.swing.border.AbstractBorder {
		...
		public ThinLoweredBevelBorder() { /* default constructor */ }
	...
	public static class EmptyIcon implements Icon {
		...
		public final void paintIcon(Component c, Graphics g, int x, int y) { /* nothing to do */ }
	}
	...
	public static void rearrangeFrames(JDesktopPane desktopPane) {
		JInternalFrame[] frames = desktopPane.getAllFrames();
		Vector<JInternalFrame> v = new Vector<JInternalFrame>();
		for (int i = frames.length - 1; i >= 0; i -= 1) {
