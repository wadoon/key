...
public class ListSelector extends ElementSelector {
	...
	public static JButton createGotoButton(final SelectionModel model, 
		...
		gotoButton.setHorizontalAlignment(SwingConstants.LEFT);
		gotoButton.setHorizontalTextPosition(SwingConstants.LEFT);
	...
	public void updateNonModelElementList(String name, final List<TreeChange> list) {
		setName(name);
