...
public class AnalysisReportTest extends TestCase {
    ...
    protected void createReport(Writer out) throws IOException {
        ...
        List<CompilationUnit> units = BasicTestsSuite.config.getSourceFileRepository().getCompilationUnits();
        // sort by name
        ...
        SourceInfo si = BasicTestsSuite.config.getSourceInfo();
            ...
            while (tw.next()) {
                ...
                if (pe instanceof Expression) {
                    ...
                    if (t != null) {
                        ...
                        if (BasicTestsSuite.config.getConstantEvaluator().isCompileTimeConstant((Expression) pe, res)) {
