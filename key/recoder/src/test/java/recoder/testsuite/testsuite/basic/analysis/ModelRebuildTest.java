...
public class ModelRebuildTest extends AnalysisReportTest {
    ...
    public void runTest() throws java.io.IOException {
        Transformation clearAll = new Transformation(BasicTestsSuite.config) {
        ...
        clearAll.execute();
        ChangeHistory ch = BasicTestsSuite.config.getChangeHistory();
        ch.updateModel();
        ...
        List<ClassType> ctl = BasicTestsSuite.config.getNameInfo().getClassTypes();
