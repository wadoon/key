...
public final class ArrayType implements ClassType {
    ...
    public boolean isPrivate() {
        return !(basetype instanceof PrimitiveType) && ((ClassType) basetype).isPrivate();
    }

    public boolean isProtected() {
        return !(basetype instanceof PrimitiveType) && ((ClassType) basetype).isProtected();
    }

    public boolean isPublic() {
        return basetype instanceof PrimitiveType || ((ClassType) basetype).isPublic();
    }
    ...
    public String getFullSignature() {
        if (basetype instanceof PrimitiveType)
            return getFullName();
        return basetype.getFullSignature() + "[]";
    }
