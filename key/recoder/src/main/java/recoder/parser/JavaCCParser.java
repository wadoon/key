...
public class JavaCCParser implements JavaCCParserConstants {
     ...
     */
    private final SourceElement.Position position = new SourceElement.Position(0, 0);
    private int jj_ntk;
    ...
    private boolean isSuperAllowed() {
        return superAllowed;
    }

    private void setAllowSuper(boolean b) {
        superAllowed = b;
    }
    ...
    final public AnnotationDeclaration AnnotationTypeDeclaration() throws ParseException {
        ...
        while (true) {
            ...
            if (jj_2_7(2147483647)) {
                ...
                setPrefixInfo(methodName);
                setPostfixInfo(methodName);
...
// this.
    ...
    final public Expression ElementValue() throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case LBRACE:
                jj_consume_token(LBRACE);
                res = factory.createElementValueArrayInitializer();
                setPrefixInfo(res);
                switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
                    case AT:
                    case BOOLEAN:
