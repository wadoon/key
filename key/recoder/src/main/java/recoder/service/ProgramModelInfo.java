...
public interface ProgramModelInfo extends Service {
     ...
     * @return
     */
    List<ClassType> removeErasedTypesFromList(
     ...
     * @param visibilityContext the context which to use for visibility checks. If null, no visibility check is performed.
     ...
     * @param name              the name of the methods in question.
     * @param signature         the statical type signature of a callee.
     * @param typeArgs          the type arguments provided to a generic method invocation. May be <code>null</code>
     * @param visibilityContext the context which to use for visibility checks. If null, no visibility check is performed.
     * @return the methods that correspond best to the given constraints.
     */
     ...
     * @since 0.90
     */
    <T extends Type> List<T> eraseTypes(List<T> types);
