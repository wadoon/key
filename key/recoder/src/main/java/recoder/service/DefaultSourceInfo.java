...
public class DefaultSourceInfo extends DefaultProgramModelInfo implements SourceInfo, ChangeHistoryListener, Formats {
    ...
    private final HashSet<ClassType> hack = new HashSet<ClassType>();
            ...
            if (op instanceof Assignment) {
                ...
                if (t1 instanceof PrimitiveType && t2 instanceof PrimitiveType) {
                    ...
                    if (t1 == getNameInfo().getNullType()) {
                        ...
                        if (t1 instanceof CapturedTypeArgument) {
                            t1 = getBaseType(((CapturedTypeArgument) t1).getTypeArgument());
                        }
                        if (t2 instanceof CapturedTypeArgument) {
                            t2 = getBaseType(((CapturedTypeArgument) t2).getTypeArgument());
                        }
