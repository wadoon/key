...
import recoder.abstraction.ParameterizedType.CapturedType;
...
//                    NonTerminalProgramElement pa = tc.getChangeRootParent();
	...
	private Type getBaseType(Type t) {
		if (t instanceof CapturedType)
    		t = ((CapturedType)t).getContainingClassType().getGenericType();
    ...
    // TODO 0.90 to be removed by distinct caches...
