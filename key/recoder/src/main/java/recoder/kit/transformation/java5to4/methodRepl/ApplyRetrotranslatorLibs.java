...
public class ApplyRetrotranslatorLibs extends TwoPassTransformation {
    ...
    private final Map<String, ClassType> completeReplacements = new HashMap<String, ClassType>();
    private final Map<String, ClassType> partialReplacements = new HashMap<String, ClassType>();
