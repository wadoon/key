...
public class TestClassAxiomAndInvariantProofReferencesAnalyst extends AbstractProofReferenceTestCase {
   ...
   public void testInvariantInOperationContract() throws Exception {
      doReferenceMethodTest(TESTCASE_DIRECTORY,
                            ...
                            new ExpectedProofReferences(IProofReference.USE_AXIOM, "equiv(java.lang.Object::<inv>(heap,self),or(equals(self,null),not(equals(Child::select(heap,self,InvariantInOperationContract::$child),null))))"));
   }
   ...
   public void testNestedInvariantInOperationContract() throws Exception {
      doReferenceMethodTest(TESTCASE_DIRECTORY,
                            ...
                            new ExpectedProofReferences(IProofReference.USE_AXIOM, "equiv(java.lang.Object::<inv>(heap,self),or(equals(self,null),not(equals(ChildContainer::select(heap,self,NestedInvariantInOperationContract::$cc),null))))"));
   }
   ...
   public void testAccessibleTest() throws Exception {
      doReferenceFunctionTest(TESTCASE_DIRECTORY,
                              ...
                              false,
                              new ClassAxiomAndInvariantProofReferencesAnalyst(),
                              new ExpectedProofReferences(IProofReference.USE_AXIOM, "equiv(java.lang.Object::<inv>(heap,self),or(equals(self,null),java.lang.Object::<inv>(heap,test.AccessibleTest::select(heap,self,test.B::$c))))"),
                              new ExpectedProofReferences(IProofReference.USE_AXIOM, "equiv(java.lang.Object::<inv>(heap,self),true)"));
   }
}
