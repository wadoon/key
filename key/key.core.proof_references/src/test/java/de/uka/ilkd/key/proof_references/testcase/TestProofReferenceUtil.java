...
public class TestProofReferenceUtil extends AbstractProofReferenceTestCase {
   ...
   public void testReferenceComputation_ExpandAndContract() throws Exception {
      doAPITest(TESTCASE_DIRECTORY,
                ...
                new ExpectedProofReferences(IProofReference.USE_CONTRACT, "pre: {heap=java.lang.Object::<inv>(heap,self)}; mby: null; post: {heap=and(and(equals(result,Z(2(4(#)))),java.lang.Object::<inv>(heap,self))<<SC>>,equals(exc,null))}; mods: {heap=allLocs, savedHeap=null}; declares: {heap=empty, savedHeap=null}; hasMod: {heap=true, savedHeap=true}; termination: diamond; transaction: false"));
   }
