...
public class LocsetInputDialog extends JDialog {
    ...
    private LocsetInputDialog(final JDialog owner, final String value) {
        super(owner, true);
        assert value != null;
    ...
    public static String showInputDialog(final JDialog owner) {
        return showInputDialog(owner, "");
    }

    public static String showInputDialog(final JDialog owner, final String value) {
        final LocsetInputDialog dia = new LocsetInputDialog(owner, value);
        dia.setVisible(true);
        dia.dispose();
        return dia.value;
    }
