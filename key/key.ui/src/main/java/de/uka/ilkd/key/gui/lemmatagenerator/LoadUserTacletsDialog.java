...
public class LoadUserTacletsDialog extends JPanel {
    ...
    private static final String HELP_TEXT =
        "In this dialog you can choose the files that are used for loading user-defined taclets:"
            ...
            + " they can be used for the current proof. For each taclet an extra proof obligation "
            + "is built that must be provable, in order to sustain the correctness of the calculus."
            + "\n\nDefinitions:\n"
            ...
            + "Beware of the fact that it is crucial for the correctness of the calculus that the "
            + "used axioms are consistent."
