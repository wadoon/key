...
public class JoinDialog extends StdDialog {
    ...
    public JoinDialog(List<ProspectivePartner> partnerList, Proof proof,
            PredicateEstimator estimator, GoalLocalSpecificationRepository localSpecRepo, Services services) {
    ...
    private static class ContentPanel extends Box {
        ...
        private static class ContentItem {
            ...
            public ContentItem(ProspectivePartner partner,
                ...
                this.inspector = new InspectorForDecisionPredicates(localSpecRepo, services,
        ...
        public ContentPanel(List<ProspectivePartner> partnerList, final Proof proof,
                ...
                final GoalLocalSpecificationRepository localSpecRepo, Services services) {
            ...
            getPredicateInput().addListener(new CheckedUserInputListener() {
                ...
                public void userInputChanged(String input, boolean valid, String reason) {
                    if (valid) {
                        getSelectedPartner().setCommonPredicate(InspectorForFormulas
                                .translate(localSpecRepo, proof.getServices(), input));
            ...
            if (!partnerList.isEmpty()) {
                fill(partnerList, localSpecRepo, services);
            }

        }

        private void fill(List<ProspectivePartner> partnerList, GoalLocalSpecificationRepository localSpecRepo, Services services) {
            ...
            for (final ProspectivePartner partner : partnerList) {
                ...
                model.addElement(new ContentItem(partner, localSpecRepo, services, applicable));
            }
