...
public class AbstractionPredicatesChoiceDialog extends JDialog {
    ...
    public AbstractionPredicatesChoiceDialog(Goal goal) {
        ...
        final String progVarsStr = goal.getGlobalProgVars().toString().replace(",", ", ");
        Platform.runLater(() -> ctrl.setAvailableProgVarsInfoTxt(progVarsStr.substring(1, progVarsStr.length() - 1)));
