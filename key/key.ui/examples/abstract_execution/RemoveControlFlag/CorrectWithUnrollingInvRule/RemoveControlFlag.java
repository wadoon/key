 ...
 * the other. We achieve this by unwinding the first loop once with a technique
 * described in [KKU17]. Furthermore, we add an intermediate version of the refactored
 * program which breaks, but still has the "done" variable. We show the equivalence
 * of the unwound with the intermediate and the intermediate with the refactored
 * program. For the second step, we strengthen the invariant of the intermediate
 * program (but do not change the program itself).
 *
