...
The examples in this section are taken from the "Abstract Execution" paper by Dominic Steinhoefel and Reiner Haehnle, submitted to FM 2019. They model refactoring techniques as described by Martin Fowler (Fowler 1999, Fowler 2018) and proof them correct, where implicit assumptions made by Fowler have been made explicit for the proof to work.
