...
public class AbstractSymbolicExecutionTestCase extends TestCase {
   ...
   protected static SymbolicExecutionEnvironment<DefaultUserInterfaceControl> createSymbolicExecutionEnvironment(File baseDir, 
      ...
      // Start proof
      final DisplayableSpecificationElement contract = (DisplayableSpecificationElement)environment.getServices().getSpecificationRepository().getContractByName(baseContractName);
