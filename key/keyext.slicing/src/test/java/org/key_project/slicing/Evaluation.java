...
//            "IdentityHashMap/01_KEY_IHM/KeY-proof-files/VerifiedIdentityHashMap/java.util.VerifiedIdentityHashMap(java.util.VerifiedIdentityHashMap__clear()).JML normal_behavior operation contract.0.proof.gz",
//            "IdentityHashMap/01_KEY_IHM/KeY-proof-files/VerifiedIdentityHashMap/java.util.VerifiedIdentityHashMap(java.util.VerifiedIdentityHashMap__containsKey(java.lang.Object)).JML normal_behavior operation contract.0.proof.gz",
//            "IdentityHashMap/01_KEY_IHM/KeY-proof-files/VerifiedIdentityHashMap/java.util.VerifiedIdentityHashMap(java.util.VerifiedIdentityHashMap__containsMapping(java.lang.Object,java.lang.Object)).JML normal_behavior operation contract.0.proof.gz",
//            "IdentityHashMap/01_KEY_IHM/KeY-proof-files/VerifiedIdentityHashMap/java.util.VerifiedIdentityHashMap(java.util.VerifiedIdentityHashMap__containsValue(java.lang.Object)).JML normal_behavior operation contract.0.proof.gz",
//            "IdentityHashMap/01_KEY_IHM/KeY-proof-files/VerifiedIdentityHashMap/java.util.VerifiedIdentityHashMap(java.util.VerifiedIdentityHashMap__get(java.lang.Object)).JML normal_behavior operation contract.0.proof.gz",
//            "IdentityHashMap/01_KEY_IHM/KeY-proof-files/VerifiedIdentityHashMap/java.util.VerifiedIdentityHashMap(java.util.VerifiedIdentityHashMap__get(java.lang.Object)).JML normal_behavior operation contract.1.proof.gz",
...
//            "IdentityHashMap/01_KEY_IHM/KeY-proof-files/VerifiedIdentityHashMap/java.util.VerifiedIdentityHashMap(java.util.VerifiedIdentityHashMap__put(java.lang.Object,java.lang.Object)).JML exceptional_behavior operation contract.0.proof.gz",
//            "IdentityHashMap/01_KEY_IHM/KeY-proof-files/VerifiedIdentityHashMap/java.util.VerifiedIdentityHashMap(java.util.VerifiedIdentityHashMap__put(java.lang.Object,java.lang.Object)).JML normal_behavior operation contract.0.proof.gz",
//            "IdentityHashMap/01_KEY_IHM/KeY-proof-files/VerifiedIdentityHashMap/java.util.VerifiedIdentityHashMap(java.util.VerifiedIdentityHashMap__put(java.lang.Object,java.lang.Object)).JML normal_behavior operation contract.1.proof.gz",
//            "IdentityHashMap/01_KEY_IHM/KeY-proof-files/VerifiedIdentityHashMap/java.util.VerifiedIdentityHashMap(java.util.VerifiedIdentityHashMap__resize(int)).JML exceptional_behavior operation contract.0.proof.gz",
//            "IdentityHashMap/01_KEY_IHM/KeY-proof-files/VerifiedIdentityHashMap/java.util.VerifiedIdentityHashMap(java.util.VerifiedIdentityHashMap__resize(int)).JML normal_behavior operation contract.0.proof.gz",
...
//            "IdentityHashMap/01_KEY_IHM/KeY-proof-files/VerifiedIdentityHashMap/java.util.VerifiedIdentityHashMap(java.util.VerifiedIdentityHashMap__resize(int)).JML normal_behavior operation contract.2.proof.gz",
    ...
    void sliceEach() throws Exception {
        ...
        for (var filename : FILES) {
            ...
            for (int i = 0; i < iterations; i++) {
                ...
                var numberOfSMT = proof1.second.allGoals().stream().filter(goal -> goal.node().getAppliedRuleApp() != null && goal.node().getAppliedRuleApp() instanceof RuleAppSMT).count();
                proof1.first.dispose();
                var time2 = System.currentTimeMillis();
    ...
    private Pair<Proof, DependencyTracker> sliceProof(String filename, boolean doDependencyAnalysis, boolean doDeduplicateRuleApps) throws Exception {
        ...
        try {
            ...
            if (!environment.getReplayResult().hasErrors()
                    && environment.getReplayResult().getStatus().equals(IntermediateProofReplayer.SMT_NOT_RUN)) {
