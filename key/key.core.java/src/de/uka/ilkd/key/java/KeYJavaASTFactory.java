...
public abstract class KeYJavaASTFactory {
     ...
     *
     * @param parameters the assignment parameters (variable, expression) as
     *                   {@link ExtList}
     ...
     * </pre>
     *
     * @param services    the {@link Services} whose {@link VariableNamer} is used to
     *                    determine a unique variable name
     * @param name        the {@link String} on which the variable's unique name is
     *                    based
     * @param initializer the {@link Expression} the declared variable is initialized
     *                    with
     ...
     * @param var      the named and typed {@link IProgramVariable} to be declared as
     *                 parameter
     ...
     *
     * @param parameters the catch clause parameters (exception, body) as
     *                   {@link ExtList}
     ...
     * </pre>
     *
     * @param javaInfo the {@link JavaInfo} containing a {@link KeYJavaType} named
     *                 <code>type</code>
     * @param param    the {@link String} name of the exception object variable
     * @param type     the <code>String</code> name of the exception object
     ...
     *
     * @param parameters the if statement parameters (guard, body, else branch) as
     *                   {@link ExtList}
     ...
     * </pre>
     *
     * @param expression the {@link Expression} to be compared against
     *                   <code>null</code>
     ...
     * @param method    the enclosing {@link IProgramMethod} defined in
     *                  <code>classType</code>
     ...
     * @param block     the {@link StatementBlock} <code>statement</code> is inserted
     *                  into
     ...
     * </pre>
     *
     * @param expression the {@link Expression} operand, whose runtime type is to be
     *                   checked
     * @param type       the {@link KeYJavaType} operand <code>expression</code>'s type
     *                   is checked against
     ...
     * </pre>
     *
     * @param model the {@link JavaInfo} to retrieve the array super class type,
     ...
     * </pre>
     *
     * @param left  the {@link Expression} to be compared less than
     *              <code>right</code>
     * @param right the <code>Expression</code> to be compared greater than
     *              <code>left</code>
     ...
     * @param model    the {@link JavaInfo} to retrieve the array super class type,
     *                 which holds the length attribute, from
     * @param variable the {@link ProgramVariable} to be compared less than
     ...
     * </pre>
     *
     * @param variable the {@link ProgramVariable} to be post incremented during the
     *                 loop updates
     ...
     * Create a for loop.
     *
     * @param parameters the loop definition parameters (initializer, guard, updates,
     ...
     * Create a local variable declaration without initialization.
     *
     * @param parameters the declaration parameters (modifiers, type reference,
     ...
     * @param specification the {@link VariableSpecification} of the variable to be
     *                      declared
     ...
     * @param modifiers      the {@link Modifier}s
     * @param typeRef        the static {@link TypeRef} of the variable to be declared
     * @param specifications the {@link VariableSpecification}s of the variables to be
     *                       declared
     ...
     * </pre>
     *
     * @param services   the {@link Services} to determine both <code>expression</code>
     ...
     * </pre>
     *
     * @param prefix the {@link ReferencePrefix} on which <code>field</code> is
     *               accessed
     ...
     *
     * @param model      the {@link JavaInfo} that contains
     ...
     * @param arguments  the <code>ProgramVariable</code> and their static types the
     ...
     * @param arguments the <code>Expression</code>s and their static types the method
     *                  is called with
     ...
     *
     * @param executionContext the <code>block</code>'s {@link IExecutionContext}
     * @param block            the {@link StatementBlock} to be put in
     *                         <code>executionContext</code>
     * @param position         the new source element's {@link PositionInfo}
     * @return a new {@link MethodFrame} that associates <code>block</code> with
     ...
     *
     * @param result           the {@link IProgramVariable} <code>block</code>'s return value
     *                         is assigned to
     * @param executionContext the <code>block</code>'s {@link IExecutionContext}
     * @param block            the {@link StatementBlock} to be put in
     *                         <code>executionContext</code>
     ...
     * @param args            the {@link Expression} arguments to be passed to the
     *                        constructor
     ...
     * Create a switch block.
     *
     * @param parameters the switch-case parameters (guard, body, branches) as
     *                   {@link ExtList}
     ...
     *
     * @param parameters the synchronized block parameters (monitor, body) as
     *                   {@link ExtList}
