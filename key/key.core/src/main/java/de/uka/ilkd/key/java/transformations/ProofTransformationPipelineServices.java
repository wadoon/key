...
public class ProofTransformationPipelineServices
        extends KeYTransformationPipelineServices {

    public ProofTransformationPipelineServices(KeYRecoderExcHandler keh) {
        super(keh);
    }
