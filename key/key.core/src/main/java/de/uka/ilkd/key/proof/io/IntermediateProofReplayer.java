...
public class IntermediateProofReplayer {
    ...
    public Result replay() {
        ...
        while (!queue.isEmpty()) {
            counter++;
            if (counter % 1000 == 0) {
                LOGGER.info("{} rules applied", counter);
            }
     ...
     *
     * @param currInterm The intermediate taclet application to create a "real"
     *                   application for.
     ...
     *
     * @param currInterm The intermediate built-in application to create a "real"
     *                   application for.
     ...
     * @throws SkipSMTRuleException         If the proof has been loaded, but the SMT solvers have not
     *                                      been run.
     ...
     * @throws SkipSMTRuleException         If the proof has been loaded, but the SMT solvers have not
     *                                      been run.
     * @throws BuiltInConstructionException In case of an error during construction of the builtin rule
     *                                      app.
     */
     ...
     * @param value      Name for the instantiated Skolem constant, program element or
     *                   term..
