 ...
 * adjustments in the body (execution context). Does not add a method frame.
 */
public class ExpandDirectMethodBody extends ProgramTransformer {

    public ExpandDirectMethodBody(SchemaVariable sv) {
        super(new Name("expand-direct-method-body"), (ProgramSV) sv);
    }

    public ExpandDirectMethodBody(Statement mb) {
        super(new Name("expand-direct-method-body"), mb);
    }
    ...
    public ProgramElement[] transform(ProgramElement pe, GoalLocalSpecificationRepository localSpecRepo,
        ...
        DirectMethodBodyStatement mbs = (DirectMethodBodyStatement) pe;
