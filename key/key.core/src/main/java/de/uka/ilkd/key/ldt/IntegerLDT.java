...
import de.uka.ilkd.key.java.ast.expression.operator.BinaryAnd;
import de.uka.ilkd.key.java.ast.expression.operator.BinaryNot;
import de.uka.ilkd.key.java.ast.expression.operator.BinaryOr;
import de.uka.ilkd.key.java.ast.expression.operator.BinaryXOr;
import de.uka.ilkd.key.java.ast.expression.operator.Divide;
import de.uka.ilkd.key.java.ast.expression.operator.GreaterOrEquals;
import de.uka.ilkd.key.java.ast.expression.operator.GreaterThan;
import de.uka.ilkd.key.java.ast.expression.operator.LessOrEquals;
import de.uka.ilkd.key.java.ast.expression.operator.LessThan;
import de.uka.ilkd.key.java.ast.expression.operator.Minus;
import de.uka.ilkd.key.java.ast.expression.operator.Modulo;
import de.uka.ilkd.key.java.ast.expression.operator.Negative;
import de.uka.ilkd.key.java.ast.expression.operator.Plus;
import de.uka.ilkd.key.java.ast.expression.operator.ShiftLeft;
import de.uka.ilkd.key.java.ast.expression.operator.ShiftRight;
import de.uka.ilkd.key.java.ast.expression.operator.Times;
import de.uka.ilkd.key.java.ast.expression.operator.TypeCast;
import de.uka.ilkd.key.java.ast.expression.operator.UnsignedShiftRight;
