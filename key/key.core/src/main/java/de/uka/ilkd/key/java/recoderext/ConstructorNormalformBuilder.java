...
public class ConstructorNormalformBuilder
    ...
    private final HashMap<ClassDeclaration, List<Constructor>> class2constructors;
    private final HashMap<ClassDeclaration, Field> class2enclosingThis;
    private final HashMap<ClassDeclaration, ClassDeclaration> class2enclosingClass;
    private final HashMap<ClassDeclaration, ASTList<Statement>> class2initializers;
    private final HashMap<ClassDeclaration, Identifier> class2identifier;
    private final HashMap<ClassDeclaration, ASTList<MethodDeclaration>> class2methodDeclaration;
    private final HashMap<ClassDeclaration, ClassType> class2superContainer;
    private final HashMap<Variable, Type> v2t;
