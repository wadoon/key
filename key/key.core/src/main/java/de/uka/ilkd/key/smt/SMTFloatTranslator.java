...
//		this.services = services;
//		SMTFile file = translateProblem(sequent);
...
//	 * @return
//	 */
//	public SMTFile translateProblem(Sequent problem) {
...
//	 */
//	public SMTTerm translateSequent(Sequent sequent) {
...
//	 * @return the SMT term.
//	 */
//	public SMTTerm translateFormulaWithDefaultValue(Sequent term, SMTTerm defaultValue) {
//		Operator op = term.op();
//
