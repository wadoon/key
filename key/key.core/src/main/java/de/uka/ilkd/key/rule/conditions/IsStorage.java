...
/**
 * This variable condition checks if a given variable's data location is storage.
 */
public final class IsStorage extends VariableConditionAdapter {

    private final boolean negated;
    private final ParsableVariable var;

    public IsStorage(ParsableVariable var, boolean negation) {
