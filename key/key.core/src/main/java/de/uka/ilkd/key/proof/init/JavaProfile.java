...
import de.uka.ilkd.key.abstractexecution.rule.*;
...
public class JavaProfile extends AbstractProfile {
    ...
    protected ImmutableList<TermLabelConfiguration> computeTermLabelConfiguration() {
        ...
        result = result.prepend(
            new TermLabelConfiguration(
                    ParameterlessTermLabel.AE_EQUIV_PROOF_LABEL_NAME,
                    new SingletonLabelFactory<TermLabel>(
                            ParameterlessTermLabel.AE_EQUIV_PROOF_LABEL)
            ));
        result = result.prepend(
            new TermLabelConfiguration(
    ...
    protected ImmutableList<BuiltInRule> initBuiltInRules() {
        ...
        builtInRules = builtInRules.prepend(WhileInvariantRule.INSTANCE)
                                   ...
                                   .prepend(SimplifyAnonAbstractRule.INSTANCE);
