...
public class LogicPrinter {
 ...
 public void printClassName (String className) throws IOException {
   ...
   /**
    ...
    // TODO (DS, 2019-05-29): Somewhere, a mixture of parallel and concatenated
    // update notation breaks something if they are used together, like in a 
    // concatenation of parallel updates. If not here, then somewhere else...
