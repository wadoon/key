...
public class OptimizedFormulaNormalization {
     ...
     *
     * The normalization can normalize arbitrary formulas by calling {@link OptimizedFormulaNormalization ::}
     *
     ...
     */
    public OptimizedFormulaNormalization(Goal goal,
                                         boolean skolemizeEx,
                                         boolean renameFirst) {
        this.node = goal.node();
    ...
    public OptimizedFormulaNormalization(TermBuilder termBuilder, TermFactory termFactory, boolean skolemizeEx,
                                         boolean renameFirst) {
        this.node = null;
