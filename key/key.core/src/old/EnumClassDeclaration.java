 ...
 * {@link EnumDeclaration} to an EnumTypeDeclaration<?> by
 * <ul>
 ...
 * <li>adding "extends Enum" to the TypeDeclaration<?>
 * </ul>
 *
 * <p>
...
public class EnumTypeDeclaration<?> extends TypeDeclaration<?> {
    ...
    public EnumTypeDeclaration<?>() {
        super();
        enumConstants = new NodeList<EnumConstantDeclaration>();
    }
    ...
    public EnumTypeDeclaration<?>(EnumDeclaration ed) {
        this();
        ...
        //
        // Declaration Specs.
        NodeList<Modifier> orgDecls = ed.getModifiers();
        NodeList<Modifier> decls;
        if (orgDecls != null)
            decls = orgDecls.deepClone();
        else
            decls = new NodeList<Modifier>();
        ...
        NodeList<MemberDeclaration> members =
                new NodeList<MemberDeclaration>();
        setMembers(members);
    ...
    private void addImplicitMethods() {
        ...
        NodeList<MemberDeclaration> members = getMembers();
        members.add(valueOf);
        members.add(values);
        members.add(name);
    }
    ...
    private void addInternalFields() {
        ...
        NodeList<Expression> nameList = new NodeList<Expression>();
    ...
    private MemberDeclaration makeConstantField(EnumConstantDeclaration ecd,
        ...
        NodeList<Expression> args = ecs.getConstructorReference().getArguments();
