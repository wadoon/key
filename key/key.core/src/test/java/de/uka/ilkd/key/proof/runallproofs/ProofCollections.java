...
public final class ProofCollections {
    final static String SETTINGS = "#Proof-Settings-Config-File\n" +
...
//                .provable("split.key");
     ...
     */
    private static void addWelldefinedness(ProofCollection c) {
        c.addGroup("wdChecks")
    ...
    private static void addModelMethods(ProofCollection c) {
        // Model methods tests:
    ...
    private static void addStrings(ProofCollection c) {
        c.addGroup("strings")
    ...
    private static void addFol(ProofCollection c) {
        c.addGroup("FOL")
    ...
    private static void addJavaDl(ProofCollection c) {
        c.addGroup("javadl")
    ...
    private static void addArrays(ProofCollection c) {
        c.addGroup("arrays")
    ...
    private static void addArithmetic(ProofCollection c) {
    ...
    private static void addWeideEtAl(ProofCollection c) {
    ...
    private static void addVSTTE10(ProofCollection c) {
        c.addGroup("VSTTE10")
    ...
    private static void addVACID0(ProofCollection c) {
        c.addGroup("VACID0")
    ...
    private static void SmansEtAl(ProofCollection c) {
    ...
    private static void addSimpleTests(ProofCollection c) {
        /*
    ...
    private static void addList(ProofCollection c) {
        c.addGroup("list")
    ...
    private static void addJavaCard(ProofCollection c) {
        c.addGroup("javaCard")
    ...
    private static void addBlockContracts(ProofCollection c) {
    ...
    private static void addPermissionHeap(ProofCollection c) {
    ...
    private static void addReloadedExamples(ProofCollection c) {
