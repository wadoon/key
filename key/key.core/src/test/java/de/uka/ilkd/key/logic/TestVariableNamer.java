...
public class TestVariableNamer extends TestCase {
    ...
    private final Proof proof = new Proof("TestVariableNamer", 
    		new InitConfig(GoalLocalSpecificationRepository.DUMMY_REPO, new Services(AbstractProfile.getDefaultProfile())));
	...
	KeYJavaType myKeyJavaType
    	...
    	return new LocationVariableBuilder(name, myKeyJavaType).create();
    }
	...
	app = (NoPosTacletApp) app.addCheckedInstantiation(sv, statement, 
                goal, goal.proof().getServices(), false);
