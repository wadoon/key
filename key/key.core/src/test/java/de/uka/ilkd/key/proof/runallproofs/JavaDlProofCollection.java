 ...
 * @version 1 (7/13/20)
 */
public class JavaDlProofCollection extends ProofCollection {

    public JavaDlProofCollection() {
        super();
        getSettings().setBaseDirectory("../");
        getSettings().setStatisticsFile("../../key.core.test/testresults/runallproofs/runStatistics.csv");
        getSettings().setForkMode(ForkMode.PERGROUP);
        getSettings().setForkTimeout(2000);
        getSettings().setReloadEnabled(true);
        getSettings().setTempDir("../../key.core.test/runallproofs_tmp");
        // forkMemory = 1000m
        // forkDebugPort = "wait:1234"
        // verboseOutput = true
        //runOnlyOn = group1,group2
        getSettings().setKeySettings(fromFile(""));

        addGroup("newBook")
                .provable("ewBook/09.list_modelfield/ArrayList.add.key")
        ...
        addGroup("performancePOConstruction")
        ...
        addGroup("applicationRestrictions")
