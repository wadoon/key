...
:
  ...
  |   ps=mergeproc_clause        { sc.addMergeProcs(ps); }
  |   ps=mergeparams_clause  { sc.addMergeParams(ps); }
...
@after { r = result; }
:
   mergeparams_keyword result=expression { result = result.prepend("merge_params "); }
;
