...
//
//public class PredicateRefinementNew2 {
//
...
//
//	public PredicateRefinementNew2(Services s, Sequent sequent, Set<Term> depPredList, Set<Term> compPredList, Term i,
//			int itr, boolean compPredFixedPoint) {
//		services = s;
...
//			if (!sequentAndCompPredsImplyPredicate(pred, fixedPoint)) {
...
//			if (sequentAndCompPredsImplyPredicate(w, fixedPoint)) {
//				depPredicates.add(w);
//			}
//		}
//		// -------------------------------------
...
//	}
//
//	private boolean sequentAndCompPredsImplyPredicate(Term pred, boolean fp) {
...
//				if (!compPredOnIndex(sequentFormula)) {
//					sideSeq = sideSeq.addFormula(sequentFormula, true, false).sequent();
//				}
//			}
//			for (Term cp : compPredicates) {
//				sideSeq = sideSeq.addFormula(new SequentFormula(cp), true, false).sequent();
//			}
//
//		} else {
//			for (SequentFormula sequentFormula : seq.antecedent()) {
...
//			System.out.println("Check this seq seperately: " + ProofSaver.printAnything(sideSeq, services));
//}
//		return provable;
//	}
//
//	private boolean compPredOnIndex(SequentFormula sequentFormula) {
//		if (sequentFormula.formula().op() == intLDT.getLessThan()
//				|| sequentFormula.formula().op() == intLDT.getLessOrEquals()
//				|| sequentFormula.formula().op() == intLDT.getGreaterThan()
//				|| sequentFormula.formula().op() == intLDT.getGreaterOrEquals()
//				|| sequentFormula.formula().op() == Equality.EQUALS) {
//			if (sequentFormula.formula().sub(0) == index || sequentFormula.formula().sub(1) == index) {
//				return true;
//			}
//		}
//		return false;
...
//			} else if (pred.op() == intLDT.getGreaterThan()) {
//				result.add(tb.gt(left, tb.subtract(right, tb.one())));
//			} else if (pred.op() == intLDT.getLessOrEquals()) {
