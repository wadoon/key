...
public class JavaBlock implements ModalContent {
     ...
     * program. It is used as a realization of the sentinel design pattern to
     * mark terms with operators that are incapable of containing a program like
     * predicate symbols.
     * 
     * If you want to have an empty program, create a new JavaBlock instance
     * with an empty statement block.
     * 
     */
     ...
     * 
     * @param prg
     *            the root StatementBlock for this JavaBlock. TacletIndex relies
     *            on <code>prg</code> being indeed a StatementBlock.
     */
     ...
     */
    public boolean equalsModRenaming(Object o, NameAbstractionTable<? extends CCSourceElement> nat) {
