...
public class TermBuilder {
    ...
    public Term anonEventUpdate(Term timestamp, Term readSet, Term writeSet, Term anonUnique) {
        return tf.createTerm(AnonEventUpdate.getAnonEventUpdateFor(services), timestamp, readSet, writeSet, anonUnique);
    }
