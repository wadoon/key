 ...
 */
public abstract class GenericAbstractSortedOperator extends GenericAbstractOperator
    ...
    protected GenericAbstractSortedOperator(Name name,
    ...
    protected GenericAbstractSortedOperator(Name name, Sort[] argSorts,
    ...
    protected GenericAbstractSortedOperator(Name name, Sort sort,
            boolean isRigid) {
