...
/**
 * Class of operators for elementary updates, i.e., updates of the form "x :=
 * t". There is one such operator for every left hand side "x". Each of these
 * operator is unary, accepting a single argument "t".
 */
public final class ElementaryUpdate extends AbstractSortedOperator {
    ...
    public static ElementaryUpdate getInstance(UpdateableOperator lhs) {
        ...
        if (result == null || result.get() == null) {
            result = new WeakReference<ElementaryUpdate>(
                new ElementaryUpdate(lhs));
