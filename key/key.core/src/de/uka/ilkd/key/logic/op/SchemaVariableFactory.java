...
public class SchemaVariableFactory {
     ...
     * @param sort
     *            the Sort of the variable the SchemaVariable will be used to
     *            represent
     ...
     *            the Name of the SchemaVariable
     * @param sort
     *            the Sort of the term the SchemaVariable will be used to
     *            represent
     * @param rigidness
     ...
     * @return the SchemaVariable
     */
    public static TermSV createTermSV(Name name, Sort sort, boolean rigidness,
            boolean strictSV) {
    ...
    public static ProgramSV createProgramSV(ProgramElementName name,
            ProgramSVSort s, boolean listSV) {
