...
/**
 * Special "sorts" used for schema variables matching program constructs (class
 * ProgramSV). Not really sorts in the theoretical meaning of the word.
 */
public abstract class ProgramSVSort extends AbstractSort {
    ...
    private static final Map<Name, ProgramSVSort> name2sort = new LinkedHashMap<Name, ProgramSVSort>(
        60);
    ...
    public static final ProgramSVSort NONSIMPLEEXPRESSIONNOCLASSREFERENCE = new NonSimpleExpressionNoClassReferenceSort();
    ...
    public static final ProgramSVSort JAVABOOLEANEXPRESSION = new ExpressionSpecialPrimitiveTypeSort(
    ...
    public static final ProgramSVSort SIMPLEJAVABYTEEXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
        "JavaByteExpression", new PrimitiveType[] { PrimitiveType.JAVA_BYTE });

    public static final ProgramSVSort SIMPLEJAVACHAREXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
        "JavaCharExpression", new PrimitiveType[] { PrimitiveType.JAVA_CHAR });

    public static final ProgramSVSort SIMPLEJAVASHORTEXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
        "JavaShortExpression",
        new PrimitiveType[] { PrimitiveType.JAVA_SHORT });

    public static final ProgramSVSort SIMPLEJAVAINTEXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
        "JavaIntExpression", new PrimitiveType[] { PrimitiveType.JAVA_INT });

    public static final ProgramSVSort SIMPLEJAVALONGEXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
        "JavaLongExpression", new PrimitiveType[] { PrimitiveType.JAVA_LONG });

    public static final ProgramSVSort SIMPLEJAVABYTESHORTEXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
        "JavaByteShortExpression", new PrimitiveType[] {
            PrimitiveType.JAVA_BYTE, PrimitiveType.JAVA_SHORT });

    public static final ProgramSVSort SIMPLEJAVABYTESHORTINTEXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
        "JavaByteShortIntExpression",
        new PrimitiveType[] { PrimitiveType.JAVA_BYTE, PrimitiveType.JAVA_SHORT,
            PrimitiveType.JAVA_INT });

    public static final ProgramSVSort SIMPLEANYJAVATYPEEXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
        "AnyJavaTypeExpression",
        new PrimitiveType[] { PrimitiveType.JAVA_BYTE, PrimitiveType.JAVA_SHORT,
            PrimitiveType.JAVA_INT, PrimitiveType.JAVA_LONG });

    public static final ProgramSVSort SIMPLEANYJAVANUMBERTYPEEXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
        "AnyJavaNumberTypeExpression",
        new PrimitiveType[] { PrimitiveType.JAVA_BYTE, PrimitiveType.JAVA_SHORT,
            PrimitiveType.JAVA_INT, PrimitiveType.JAVA_LONG,
            PrimitiveType.JAVA_CHAR });

    public static final ProgramSVSort SIMPLEJAVASHORTINTLONGEXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
        "JavaShortIntLongExpression",
        new PrimitiveType[] { PrimitiveType.JAVA_SHORT, PrimitiveType.JAVA_INT,
            PrimitiveType.JAVA_LONG });

    public static final ProgramSVSort SIMPLEJAVAINTLONGEXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
        "JavaIntLongExpression", new PrimitiveType[] { PrimitiveType.JAVA_INT,
            PrimitiveType.JAVA_LONG });

    public static final ProgramSVSort SIMPLEJAVACHARBYTESHORTINTEXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
    ...
    public static final ProgramSVSort SIMPLEJAVABIGINTEXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
        "JavaBigintExpression",
        new PrimitiveType[] { PrimitiveType.JAVA_BIGINT });

    public static final ProgramSVSort SIMPLEANYNUMBERTYPEEXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
        "AnyNumberTypeExpression",
        new PrimitiveType[] { PrimitiveType.JAVA_BYTE, PrimitiveType.JAVA_SHORT,
            PrimitiveType.JAVA_INT, PrimitiveType.JAVA_LONG,
            PrimitiveType.JAVA_CHAR, PrimitiveType.JAVA_BIGINT });

    public static final ProgramSVSort SIMPLEJAVABOOLEANEXPRESSION = new SimpleExpressionSpecialPrimitiveTypeSort(
        "SimpleJavaBooleanExpression",
        new PrimitiveType[] { PrimitiveType.JAVA_BOOLEAN });

    public static final ProgramSVSort SIMPLESTRINGEXPRESSION = new SimpleExpressionStringSort(
        "SimpleStringExpression");

    public static final ProgramSVSort SIMPLENONSTRINGOBJECTEXPRESSION = new SimpleExpressionNonStringObjectSort(
        "SimpleNonStringObjectExpression");
    ...
    public static final ProgramSVSort CONSTANT_PRIMITIVE_TYPE_VARIABLE = new ConstantProgramVariableSort(
        new Name("ConstantPrimitiveTypeVariable"), false);

    public static final ProgramSVSort CONSTANT_STRING_VARIABLE = new ConstantProgramVariableSort(
        new Name("ConstantStringVariable"), true);

    public static final ProgramSVSort VARIABLEINIT = new ProgramSVSort(
        new Name("VariableInitializer")) {
        @Override
        ...
        protected boolean canStandFor(ProgramElement pe, Services services) {
            ...
            if (pe instanceof FieldReference) {
                ...
                if ((fr.getProgramVariable()).isStatic()) {
                    return (rp == null || rp instanceof ThisReference
    ...
    private static class SimpleExpressionSort extends ProgramSVSort {
        ...
        protected boolean canStandFor(ProgramElement pe, Services services) {
            ...
            if (pe instanceof SetUnion || pe instanceof Singleton
                    || pe instanceof Intersect || pe instanceof SetMinus
                    || pe instanceof AllFields || pe instanceof SeqSingleton
                    || pe instanceof SeqConcat || pe instanceof SeqLength
                    || pe instanceof SeqGet || pe instanceof SeqIndexOf
                ...
                if (pe instanceof NonTerminalProgramElement) {
                    ...
                    for (int i = 0, childCount = npe
                            .getChildCount(); i < childCount; i++) {
                ...
                // this is a not so nice special case (all expressiosn within
                // embedded expressions are considered to
                // be side effect free; to handle it properly we need some meta
                // constructs to decompose these expressions
                return true;
            }
    ...
    private static class NonSimpleExpressionNoClassReferenceSort
            extends NonSimpleExpressionSort {
    ...
    /**
     * This sort represents a type of program schema variables that match only
     * on Class Instance Creation Expressions, new C(), where all arguments are
     * simple expressions.
     */
    ...
    /**
     * This sort represents a type of program schema variables that match only
     * on Class Instance Creation Expressions, new C(), where at least one
     * argument is a non-simple expression
     */
    ...
    private static final class NonModelMethodBodySort extends ProgramSVSort {
        ...
        protected boolean canStandFor(ProgramElement pe, Services services) {
            ...
            final IProgramMethod pm = ((MethodBodyStatement) pe)
                    .getProgramMethod(services);
            if (pm == null) {
                return false;
            }
            final MethodDeclaration methodDeclaration = pm
     ...
     * ARGUMENTS.
     */
    private static final class NonSimpleMethodReferenceSort
        ...
        protected boolean canStandFor(ProgramElement pe, Services services) {
            if (pe instanceof MethodReference) {
                 ...
                 * mr.getReferencePrefix() instanceof TypeReference) { return
                 * false; }
                 */
                if (mr.getReferencePrefix() != null && NONSIMPLEEXPRESSION
                        .canStandFor(mr.getReferencePrefix(), services)) {
                    return false;
                }
     ...
     */
    private static final class TypeReferenceNotPrimitiveSort
            extends ProgramSVSort {
        ...
        protected boolean canStandFor(ProgramElement check, Services services) {
            if (!(check instanceof TypeReference))
                return false;
            if (((TypeReference) (check)).getKeYJavaType()
                    .getJavaType() instanceof PrimitiveType)
                return false;
            if (matchName != null) {
                return matchName.equals(((TypeReference) (check))
     ...
     *
     * It can also be made to match only specific method names defined by the
     * parameter "name".
     */
    private static class MethodNameSort extends ProgramSVSort {
        ...
        public MethodNameSort(ProgramElementName name) {
            super(new Name(
                "MethodName" + (name != null ? "[name=" + name + "]" : "")));
    ...
    public static final class SimpleExpressionStringSort
        ...
        public boolean canStandFor(ProgramElement check, ExecutionContext ec,
            ...
            // String Literal has SideEffects, but SimpleExpressionSort will not
            // match
            ...
            if (check instanceof ProgramVariable) {
                ...
                return ((ProgramVariable) check).getKeYJavaType().getSort()
                        .equals(stringSort);
            }
            return false;
        }
    ...
    private static final class ExpressionSpecialPrimitiveTypeSort
        ...
        public ExpressionSpecialPrimitiveTypeSort(String name,
                PrimitiveType[] allowed_types) {
    ...
    private static final class MultipleVariableDeclarationSort
            extends ProgramSVSort {
    ...
    private static final class ArrayPostDeclarationSort extends ProgramSVSort {
        ...
        protected boolean canStandFor(ProgramElement pe, Services services) {
            return pe instanceof VariableDeclaration
                    && ((VariableDeclaration) pe).getVariables().size() == 1
                    && ((VariableDeclaration) pe).getVariables().get(0)
                            .getDimensions() > 0;
