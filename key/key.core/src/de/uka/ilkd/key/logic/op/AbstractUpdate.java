...
public final class AbstractUpdate extends AbstractSortedOperator {
     ...
     */
    public static List<Term> getAssignables(Term t, LocSetLDT locSetLDT) {
        ...
        if (t.op() != locSetLDT.getUnion()) {
            ...
            result.addAll(getAssignables(t.sub(0), locSetLDT));
            result.addAll(getAssignables(t.sub(1), locSetLDT));
            return result;
        }
    }
}