...
import de.uka.ilkd.key.rule.metaconstruct.GetFrameCondition;
...
/**
 * Abstract class factoring out commonalities of typical term transformer
 * implementations. The available singletons of term transformers are kept here.
 */
public abstract class AbstractTermTransformer extends AbstractSortedOperator
    ...
    public static final AbstractTermTransformer ANON_UPDATE_TRANSFORMER = new AnonUpdateTransformer();
