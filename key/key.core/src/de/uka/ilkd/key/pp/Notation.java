...
public abstract class Notation {
     ...
     * The standard concrete syntax for parallel updates
     */
    public static final class ConcatenatedUpdateNotation extends Notation {
        public ConcatenatedUpdateNotation() {
            super(50);
        }

        @Override
        public void print(Term t, LogicPrinter sp) throws IOException {
            assert t.op() == UpdateJunctor.CONCATENATED_UPDATE;

            sp.printParallelUpdate("++", t, 20);
        }
    }
    ...
    public static final class Subst extends Notation {
        ...
        public void print(Term t, LogicPrinter sp) throws IOException {
            ...
            final int assTarget = (t.sort() == Sort.FORMULA
                    ? (t.sub(1).op() == Equality.EQUALS ? 75 : 60)
                    : 110);
            sp.printSubstTerm("{\\subst ", v, t.sub(0), 0, "}", t.sub(1),
                    assTarget);
        }

        private QuantifiableVariable instQV(Term t, LogicPrinter sp,
                int subTerm) {
                ...
                if (o instanceof ProgramElement) {
                    ...
                    if (o instanceof ImmutableList) {
                        final Iterator<Object> it =
                                ((ImmutableList<Object>) o).iterator();
    ...
    public static final class SeqConcatNotation extends Notation {
        ...
        public SeqConcatNotation(Function seqConcat, Function seqSingleton,
        ...
        private String printStringTerm(Term t) {
            ...
            while (term.op().arity() == 2) {
                result = result + CharLiteral.printCharTerm(term.sub(0).sub(0))
                        .charAt(1);
                term = term.sub(1);
            }
