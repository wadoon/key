...
public class TacletApplPart {
    ...
    /**
     * constructs a new TacletApplPart object with the given Sequent, a list of
     * variables that are new, a list of variable pairs that represent the
     * NotFreeIn relation and a list of additional generic variable conditions.
     *
     * @param newSkolemUpdates
     *            TODO
     */
    ...
    /**
     * returns the list of variable pairs that represent the NotFreeIn relation
     * of a Taclet
     */
    ...
    /**
     * returns the list of variable pairs that represent the "new depending on"
     * relation of a Taclet
     */
    ...
    /**
     * returns the list of additional generic conditions on instantiations of
     * schema variables. The list ist readonly.
     */
