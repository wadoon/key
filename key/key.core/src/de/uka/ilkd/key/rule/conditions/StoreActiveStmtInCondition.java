...
/**
 * Stores the given active {@link Statement}, after substitution of
 * {@link SchemaVariable}s, into the given {@link ProgramSV} for later use in
 * other conditions and transformers.
 *
 * @author Dominic Steinhoefel
 */
public class StoreActiveStmtInCondition implements VariableCondition {
    private final ProgramSV storeInSV;
    private final Term term;

    public StoreActiveStmtInCondition(ProgramSV resultVarSV, Term term) {
