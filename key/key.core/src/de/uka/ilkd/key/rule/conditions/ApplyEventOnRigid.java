...
public final class ApplyEventOnRigid implements VariableCondition {

	private final UpdateSV u;
	private final SchemaVariable x;
	private final SchemaVariable x2;

	public ApplyEventOnRigid(UpdateSV u, SchemaVariable x, SchemaVariable x2) {
		this.u = u;
		this.x = x;
		this.x2 = x2;
	}
	...
	public String toString() {
		return "\\applyEventOnRigid(" + u + ", " + x + ", " + x2 + ")";
	}
}