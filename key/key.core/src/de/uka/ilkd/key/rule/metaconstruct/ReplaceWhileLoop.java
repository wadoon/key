...
/**
 * This visitor is used to identify and replace the while loop in invariant
 * rule.
 * 
...
public class ReplaceWhileLoop extends CreatingASTVisitor {
    ...
    protected void walk(ProgramElement node) {
        if ((node instanceof While || node instanceof EnhancedFor)
                && !firstWhileFound) {
    ...
    /*
     * spot the first the loop and remember it. This loop may be a while or also
     * a foreach loop
     */
