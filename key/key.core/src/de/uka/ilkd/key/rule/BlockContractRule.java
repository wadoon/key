...
public class BlockContractRule implements BuiltInRule {
    ...
    private final static class GoalsConfigurator {
        ...
        public void setUpValidityGoal(final Goal goal, final Term[] updates,
            ...
            newPost = AbstractOperationPO.addAdditionalUninterpretedPredicateIfRequired(services, newPost, ImmutableSLList.<LocationVariable>nil().prepend(terms.remembranceLocalVariables.keySet()), null, terms.exception);
