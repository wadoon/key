...
public class InitArrayCreation extends InitArray {
    ...
    private If checkNegativeDimension(Expression cond,
				      Services services) {
	final New exception = KeYJavaASTFactory.newOperator(services.getProgramServices().getJavaInfo().getKeYJavaType(
	...
	final KeYJavaType intType = services.getProgramServices().getJavaInfo()
