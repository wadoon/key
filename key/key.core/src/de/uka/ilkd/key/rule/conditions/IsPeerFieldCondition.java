...
/**
 * This variable condition checks if the given field denotes a peer field.
 * @author Wolfram Pfeifer
 */
public class IsPeerFieldCondition extends VariableConditionAdapter {
    ...
    /**
     * Creates a new IsPeerFieldCondition.
     * @param f the Field SchemaVariable
     * @param negation true iff the condition is negated
     */
    public IsPeerFieldCondition(final SchemaVariable f, boolean negation) {
        this.f = f;
    ...
    public boolean check(SchemaVariable var, SVSubstitute instCandidate, SVInstantiations instMap,
        ...
        if (instCandidate instanceof Term) {
            ...
            if (op instanceof Function) {
                ...
                boolean repField = attributeName.startsWith("peer_");
