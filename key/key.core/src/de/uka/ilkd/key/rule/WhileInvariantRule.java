...
public final class WhileInvariantRule implements BuiltInRule {
    ...
    private Pair<Term,Term> prepareVariant (Instantiation inst, Term variant, TermServices services) {
        ...
        final LocationVariable variantPV = new LocationVariable(variantName, SpecialSorts.ANY);
	...
	public Instantiation(Term u, 
	    ...
	    assert u != null;
	    assert u.sort() == SpecialSorts.UPDATE;
	    assert progPost != null;
	    assert progPost.sort() == SpecialSorts.FORMULA;
	    assert loop != null;
	    assert inv != null;
	    this.u = u;
