...
public class ExpandMethodBody extends ProgramTransformer {
    ...
    /**
     * Replaces the MethodBodyStatement shortcut with the full body, performs
     * prefix adjustments in the body (execution context).
     * 
     * @param services
    ...
    public ProgramElement transform(ProgramElement pe, Services services,
        ...
        return KeYJavaASTFactory.methodFrame(
