...
public class SuccTaclet extends FindTaclet {
     ...
     *            if-sequent, the variable conditions
     * @param goalTemplates
     *            a list of goal descriptions.
     * @param heuristics
     *            a list of heurisics for the Taclet
     * @param attrs
    ...
    public SuccTaclet(Name name, TacletApplPart applPart,
            ...
            ImmutableList<RuleSet> heuristics, TacletAttributes attrs,
            Term find, boolean ignoreTopLevelUpdates,
            ImmutableMap<SchemaVariable, TacletPrefix> prefixMap,
            ImmutableSet<Choice> choices,
            ImmutableSet<TacletAnnotation> tacletAnnotations) {
        super(name, applPart, goalTemplates, heuristics, attrs, find, prefixMap,
    ...
    public SuccTaclet setName(String s) {
        ...
        return new SuccTaclet(new Name(s), applPart, goalTemplates(),
            getRuleSets(), attrs, find, ignoreTopLevelUpdates, prefixMap,
            choices, tacletAnnotations);
    }
