...
public class NoFindTaclet extends Taclet {
     ...
     * @param goalTemplates
     *            the IList<TacletGoalTemplate> containg all goal descriptions
     *            of the taclet to be created
     * @param ruleSets
    ...
    /**
     * the empty set as a no find taclet has no other entities where variables
     * cann occur bound than in the goal templates
     *
     * @return empty set
     */
    @Override
    ...
    public NoFindTaclet setName(String s) {
        ...
        return new NoFindTaclet(new Name(s), applPart, goalTemplates(),
            getRuleSets(), attrs, prefixMap, choices, tacletAnnotations);
    }
