...
/**
 * Represents an input from a .key user problem file producing an environment as
...
public final class KeYUserProblemFile extends KeYFile implements ProofOblInput {
     ...
     * reading.
     */
    public KeYUserProblemFile(String name, File file, ProgressMonitor monitor,
            Profile profile) {
    ...
    public ImmutableSet<PositionedString> read() throws ProofInputException {
        ...
        try {
            ...
            problemParser = new KeYParserF(ParserMode.PROBLEM,
                    new KeYLexerF(getNewStream(), file.toString()), pc, pc,
                    null, null);
        ...
        try {
            SLEnvInput slEnvInput = new SLEnvInput(readJavaPath(),
                    readClassPath(), readBootClassPath(), getProfile(), null);
    ...
    public void readProblem() throws ProofInputException {
        ...
        try {
            ...
            problemParser = new KeYParserF(ParserMode.PROBLEM, lexer,
                    schemaConfig, normalConfig, initConfig.getTaclet2Builder(),
                    initConfig.getTaclets());

            problemTerm = problemParser.parseProblem();

            if (problemTerm == null) {
                boolean chooseDLContract =
                        problemParser.getChooseContract() != null;
                boolean proofObligation =
                        problemParser.getProofObligation() != null;
    ...
    public ProofAggregate getPO() throws ProofInputException {
        ...
        return ProofAggregate.createProofAggregate(
                new Proof(name, problemTerm, problemHeader, initConfig), name);
    }
     ...
     *
     * @return The {@link Profile} defined by the file to load or {@code null}
     *         if no {@link Profile} is defined by the file.
     * @throws Exception
     *             Occurred Exception.
     */
    protected Profile readProfileFromFile() throws Exception {
        ...
        try {
            stream = getNewStream();
            KeYParserF problemParser = new KeYParserF(ParserMode.GLOBALDECL,
                    new KeYLexerF(stream, file.toString()));
