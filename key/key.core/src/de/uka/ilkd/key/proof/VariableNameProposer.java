...
public class VariableNameProposer implements InstantiationProposer {
    ...
    /**
     * Returns an instantiation proposal for the schema variable var. Currently
     * supports names for skolemterm SVs, variable SVs, and labels.
     */
    @Override
    ...
    /**
     * Generates a proposal for the instantiation of the given term schema
     * variable, which is declared as skolem term SV.
     */
    ...
    protected static String createBaseNameProposalBasedOnCorrespondence(
        ...
        return doubledUnderScores.matcher(matcher.replaceAll("_"))
                .replaceAll("");
    }
    ...
    public String getNameProposal(String basename, Services services,
            Node undoAnchor) {
        final NamespaceSet nss = services.getNamespaces();
        Name l_name;
        String name = "";
    ...
    /**
     * Generates a proposal for the instantiation of the given schema variable,
     * which is a variable SV.
     *
    ...
    private String getNameProposalForVariableSV(TacletApp app,
            SchemaVariable var, TermServices services,
            ImmutableList<String> previousProposals) {

        String baseName = var.name().toString();
        if (previousProposals == null
                || !previousProposals.contains(baseName)) {
            return baseName;
        }
    ...
    /**
     * Generates a proposal for the instantiation of the given schema variable,
     * which is of sort label.
     *
     * @param previousProposals
     */
    private String getNameProposalForLabel(TacletApp app, SchemaVariable var,
            Services services, Node undoAnchor,
            ImmutableList<String> previousProposals) {

        ProgramElement contextProgram = app.matchConditions()
                .getInstantiations().getContextInstantiation().contextProgram();
