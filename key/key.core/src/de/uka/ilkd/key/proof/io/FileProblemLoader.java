 ...
 * {@link SingleThreadProblemLoaderFactory} or {@link ProblemLoader}
 ...
 */
public class FileProblemLoader extends AbstractProblemLoader {
    ...
    public FileProblemLoader(File file, 
            List<File> classPath, 
            File bootClassPath,
            List<File> includes,
            ProblemLoaderControl control) {
        this(file, classPath, bootClassPath, includes, AbstractProfile.getDefaultProfile(), false, control, false,
                null);
    }
    ...
    public FileProblemLoader(File file, 
        ...
        this(file, classPath, bootClassPath, includes, profileOfNewProofs, forceNewProfileOfNewProofs, control, false,
                poPropertiesToForce);
    }
     ...
     */
    protected ProofAggregate createProofAggregate(LoadedPOContainer poContainer) throws ProofInputException {
        if (poContainer == null) {
            if (askUiToSelectAProofObligationIfNotDefinedByLoadedFile) {
                ...
                // Do not instantiate any proof but allow the user of the
                // DefaultProblemLoader
