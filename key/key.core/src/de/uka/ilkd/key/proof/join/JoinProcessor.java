...
public class JoinProcessor implements Runnable {
    ...
    private SequentFormula<Term> findFormula(Sequent sequent, Term content,
            boolean antecedent) {
        for (SequentFormula<Term> sf : (antecedent ? sequent.antecedent() : sequent
                .succedent())) {
