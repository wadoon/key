...
public class PermissionLDT extends LDT {
    ...
    public boolean isResponsible(de.uka.ilkd.key.java.expression.Operator op, Term sub, org.key_project.common.core.logic.TermServices services, ExecutionContext ec) {
        return false;
    }
