...
public final class HeapLDT extends LDT {
	...
	assert fieldPV != services.getProgramServices().getJavaInfo().getArrayLength();
    ...
    public Expression translateTerm(Term t, ExtList children, Services services) {
    	if (t.op() instanceof SortDependingFunction && 
    		...
    		return services.getProgramServices().getJavaInfo().getAttribute(getPrettyFieldName(t.op()), getClassName((Function) t.op()));
    	}
