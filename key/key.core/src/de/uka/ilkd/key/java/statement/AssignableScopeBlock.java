...
public class AssignableScopeBlock extends JavaStatement
    ...
    protected final IProgramVariable assignablePV;
    protected final StatementBlock body;
    private final MethodFrame innerMostMethodFrame;
    private final int prefixLength;

    public AssignableScopeBlock(StatementBlock body) {
        this.body = body;
        this.assignablePV = null;
     ...
     * @param body
     */
    public AssignableScopeBlock(IProgramVariable iProgramVariable, StatementBlock body) {
        this.assignablePV = iProgramVariable;
        this.body = body;
        ProgramPrefixUtil.ProgramPrefixInfo info = ProgramPrefixUtil
                .computeEssentials(this);
        prefixLength = info.getLength();
     ...
     */
    public AssignableScopeBlock(ExtList children) {
        super(children);
        assignablePV = children.get(IProgramVariable.class);
    ...
    public Expression getExpressionAt(int index) {
        if (assignablePV != null && index == 0) {
            return (ProgramVariable) assignablePV; //XXX This cast may fail...
        }
     ...
     */
    public IProgramVariable getAssignablePV() {
        return assignablePV;
    }
    ...
    public void visit(Visitor v) {
        v.performActionOnAssignableScopeBlock(this);
    }

    @Override
    public void prettyPrint(PrettyPrinter p) throws java.io.IOException {
        p.printAssignableScopeBlock(this);
    }
}