...
/**
 * this is a collection of common services to the KeY prover. Services include
 * information on the underlying Java model and a converter to transform Java
 * program elements to logic (where possible) and back.
 */
public class Services implements TermServices {
    ...
    /**
     * used to determine whether an expression is a compile-time constant and if
     * so the type and result of the expression
     */
     ...
     * object with no information stored at none of these.
     */
    ...
    /**
     * Returns the ConstantExpressionEvaluator associated with this Services
     * object.
     */
    ...
    /**
     * creates a new services object containing a copy of the java info of this
     * object and a new TypeConverter (shallow copy) The copy does not belong to
     * a {@link Proof} object and can hence be used for a new proof.
     *
     * @param shareCaches
     *            {@code true} The created {@link Services} will use the same
     *            {@link ServiceCaches} like this instance; {@code false} the
     *            created {@link Services} will use a new empty
     *            {@link ServiceCaches} instance.
     * @return the copy
     */
    ...
    /**
     * Creates a copy of this {@link Services} in which the {@link Profile} is
     * replaced. The copy does not belong to a {@link Proof} object and can
     * hence be used for a new proof.
     *
     * @param profile
     *            The new {@link Profile} to use in the copy of this
     *            {@link Services}.
     * @param shareCaches
     *            {@code true} The created {@link Services} will use the same
     *            {@link ServiceCaches} like this instance; {@code false} the
    ...
    /**
     * Generate a copy of this object. All references are copied w/o duplicating
     * their content.
     *
    ...
    /**
     * Creates a deep copy of {@link #counters} which means that a new list is
     * created with a copy of each contained {@link Counter}.
     *
    ...
    /**
     * creates a new service object with the same ldt information as the actual
     * one
     */
    ...
    /**
     * Marks this services as proof specific Please make sure that the
     * {@link Services} does not not yet belong to an existing proof or that it
     * is owned by a proof environment. In both cases copy the
     * {@link InitConfig} via {@link InitConfig#deepCopy()} or one of the other
     * copy methods first.
     *
     * @param p_proof
