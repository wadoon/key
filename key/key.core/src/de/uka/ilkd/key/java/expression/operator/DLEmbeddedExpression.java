...
public class DLEmbeddedExpression extends Operator {
    ...
    public KeYJavaType getKeYJavaType(Services javaServ, ExecutionContext ec) {
        ...
        if(kjt != null) {
            ...
            return javaServ.getProgramServices().getJavaInfo().getKeYJavaType(PrimitiveType.JAVA_INT);
        }
    }
    ...
    public void check(Services javaServ, 
        ...
        for (int i = 0; i < actual; i++) {
            ...
            KeYJavaType kjtActual = javaServ.getProgramServices().getTypeConverter().getKeYJavaType(child, ec);
    ...
    private static KeYJavaType getKeYJavaType(Services javaServ, Sort argSort) {
        ...
        // other paths.
        JavaInfo javaInfo = javaServ.getProgramServices().getJavaInfo();
