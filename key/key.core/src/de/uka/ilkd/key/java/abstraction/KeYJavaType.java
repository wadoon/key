...
/**
 * The KeY java type realises a tuple (sort, type) of a logic sort and the java
 * type (for example a class declaration). In contrast to other classes the
 * KeYJavaType is <emph>not</emph> immutable, so use it with care.
 */
