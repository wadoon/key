 ...
 */
public class ProgramElementAppender extends CreatingASTVisitor {

    Function<ProgramElement, Boolean> filter;
    private ProgramElement newElement;

    public ProgramElementAppender(JavaProgramElement program,
            Services services) {
    ...
    protected void doAction(ProgramElement element) {
        if (filter.apply(element)) {
            addChild(new StatementBlock((Statement) element,
