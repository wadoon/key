...
/**
 * Walks through a java AST in depth-left-fist-order. You can set the type of
 * nodes you want to collect and then start the walker. The found nodes of the
 * given type are returned as a IList<JavaProgramElement>
 */
public class JavaASTCollector extends JavaASTWalker {
     ...
     * @param type
     *            the Class representing the type of nodes that have to be
     *            collected
     */
