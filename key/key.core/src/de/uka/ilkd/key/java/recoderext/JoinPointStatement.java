...
public class JoinPointStatement extends JavaStatement
     ...
     * to call {@link #setIndexPV(Expression)} afterward.
     */
     ...
     * @param body
     */
    public JoinPointStatement(Expression resultVar) {
        this.indexPV = resultVar;
        makeParentRoleValid();
    }

    protected JoinPointStatement(JoinPointStatement proto) {
        super(proto);
     ...
     * @return the object
     */
    public JoinPointStatement deepClone() {
        return new JoinPointStatement(this);
    }
