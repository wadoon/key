...
/**
 * walks through a java AST in depth-left-fist-order at default. Implementing
 * method doAction specifies its behaviour at the different Nodes. The
 * depth-left-fist behaviour can be changed by overwriting the method
 * <code> walk(ProgramElement) </code>.
 */
    ...
    protected void walk(ProgramElement node) {
        if (node instanceof NonTerminalProgramElement) {
            ...
            for (int i = 0; i < nonTerminalNode.getChildCount(); i++) {
                // System.out.println("ASTWalker - node.childAt(i):
                // "+nonTerminalNode.getChildAt(i));
