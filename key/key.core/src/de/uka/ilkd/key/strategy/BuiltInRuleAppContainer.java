...
public class BuiltInRuleAppContainer extends RuleAppContainer {
    ...
    static RuleAppContainer createAppContainer(
        ...
        final long timeInMicros = (System.nanoTime() - start) / 1000;
        builtIns++;
        if (timeInMicros > longest)
            longest = timeInMicros;
        System.out.println(String.format("%d builtin containers created, longest: %d micros", builtIns, longest));
