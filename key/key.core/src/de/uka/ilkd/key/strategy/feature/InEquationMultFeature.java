...
public abstract class InEquationMultFeature extends BinaryTacletAppFeature {
    ...
    protected final boolean filter(TacletApp app, PosInOccurrence pos, Goal goal, MutableState mState) {
        ...
        final Monomial targetM =
            Monomial.create ( targetCandidate.toTerm ( app, pos, goal, mState ),
                              services );
        final Monomial mult1M =
            Monomial.create ( mult1Candidate.toTerm ( app, pos, goal, mState ),
                              services );                
        final Monomial mult2M =
            Monomial.create ( mult2Candidate.toTerm ( app, pos, goal, mState ),
                              services );
