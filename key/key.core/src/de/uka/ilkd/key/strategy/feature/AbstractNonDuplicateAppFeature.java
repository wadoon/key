...
public abstract class AbstractNonDuplicateAppFeature
        extends BinaryTacletAppFeature {
    ...
    protected boolean sameApplication(RuleApp ruleCmp, TacletApp newApp,
        ...
        final ImmutableList<IfFormulaInstantiation> newAppIfFmlInstantiations = newApp
                .ifFormulaInstantiations();
        final ImmutableList<IfFormulaInstantiation> cmpIfFmlInstantiations = cmp
                .ifFormulaInstantiations();
        if (newAppIfFmlInstantiations == null
            ...
            final Iterator<IfFormulaInstantiation> it0 = newAppIfFmlInstantiations
                    .iterator();
            final Iterator<IfFormulaInstantiation> it1 = cmpIfFmlInstantiations
                    .iterator();
    ...
    private boolean subset(
        ...
        final Iterator<ImmutableMapEntry<SchemaVariable, InstantiationEntry<?>>> it = insts0
                .iterator();

        while (it.hasNext()) {
            final ImmutableMapEntry<SchemaVariable, InstantiationEntry<?>> entry0 = it
                    .next();
     ...
     * sequent
     */
    protected boolean noDuplicateFindTaclet(TacletApp app, PosInOccurrence pos,
            Goal goal) {
