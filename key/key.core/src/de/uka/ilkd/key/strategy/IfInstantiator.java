...
public class IfInstantiator {
     ...
     */
    private void findIfFormulaInstantiationsHelp(ImmutableList<SequentFormula<Term>> p_ifSeqTail,
            ImmutableList<SequentFormula<Term>> p_ifSeqTail2nd, ImmutableList<IfFormulaInstantiation> p_alreadyMatched,
