...
public interface ProofControl {
   ...
   /**
    * Runs the given {@link ProofMacro} at the given {@link PosInOccurrence<Term>} on the given {@link Node}.
    * @param node The {@link Node} to start macro at.
    * @param macro The {@link ProofMacro} to execute.
    * @param posInOcc The exact {@link PosInOccurrence<Term>} at which the {@link ProofMacro} is started at.
    */
