...
Some files were edited by hand afterwards (Object, Class, Thread, AtomicInteger, and all exception types) to remove method stubs, to add bodies to method or constructors (being empty or calling super()), or to add JML specifications. TODO: This is very inconsistent and undocumented.
