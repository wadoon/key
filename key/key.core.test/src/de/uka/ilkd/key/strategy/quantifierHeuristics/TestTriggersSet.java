...
public class TestTriggersSet extends TestCase {
    ...
    public void setUp() {
        ...
        prs = new Function(new Name("prs"), Sort.FORMULA, new Sort[] { r, s });
        prt = new Function(new Name("prt"), Sort.FORMULA, new Sort[] { r, t });
        pst = new Function(new Name("pst"), Sort.FORMULA, new Sort[] { s, t });
        ...
        proof.setNamespaces(new NamespaceSet(variables, functions, sorts,
            ...
            new Namespace<IProgramVariable>(), new Namespace<>()));

    }

    private Term parseTerm(String termstr) {
        return TacletForTests.parseTerm(termstr,
            new NamespaceSet(variables, functions, sorts,
                new Namespace<RuleSet>(), new Namespace<Choice>(),
                new Namespace<IProgramVariable>(), new Namespace<>()));
    }
