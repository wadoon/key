...
public class TestDeclParser extends TestCase {
	...
	Sort objectSort = serv.getProgramServices().getJavaInfo().objectSort();
	Sort cloneableSort = serv.getProgramServices().getJavaInfo().cloneableSort();
        Sort serializableSort = serv.getProgramServices().getJavaInfo().serializableSort();
