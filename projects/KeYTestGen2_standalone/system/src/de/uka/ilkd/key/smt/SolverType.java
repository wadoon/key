...
public interface SolverType extends PipeListener<SolverCommunication> {
    ...
    static public final SolverType KeYnterpol = new AbstractSolverType() {
        ...
        /**
         * @return output delimiters for KeYnterpol.
         */
        public String[] getDelimiters() {
        ...
        /**
         * @return if the solver supports if-then-else branches.
         */
        public boolean supportsIfThenElse() {
        ...
        /**
         * @return an {@link SmtLib2Translator} for KeYnterpol to use.
         */
        @Override
        public SMTTranslator createTranslator(Services services) {
        ...
        /**
         * @return applicable information about the solver.
         */
        @Override
        public String getInfo() {

            return "This is KeYnterpol. It is considerably awesome.";
        }
    ...
    static public final SolverType YICES_SOLVER = new AbstractSolverType() {
        ...
        public SMTTranslator createTranslator(Services services) {
            ...
            return new SmtLibTranslator(services, new Configuration(true, true));
        }
