...
public interface ITestCaseGenerator {
     ...
     * @param includeProtected set to true to generate test cases also for protected methods.
     * @param includePrivate   set to true to generate test cases also for private methods.
     ...
     *
     * @param source   path to the Java source file
     * @param methods  the methods to generate the test cases for.
     * @param coverage code coverage critera to be satisfied by the generated test
     *                 cases. May be <code>nulll</code>, in which case a default
     *                 statement coverage is used.
     * @return a test suite for the framework targeted by the implementor.
