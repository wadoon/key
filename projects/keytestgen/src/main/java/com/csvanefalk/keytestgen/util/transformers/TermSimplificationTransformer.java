...
/**
 * Created by christopher on 20/01/14.
 */
public class TermSimplificationTransformer extends AbstractTermTransformer {

    private static TermSimplificationTransformer instance = null;

    public static TermSimplificationTransformer getInstance() {
        if (TermSimplificationTransformer.instance == null) {
            TermSimplificationTransformer.instance = new TermSimplificationTransformer();
        }
        return TermSimplificationTransformer.instance;
    }

    private TermSimplificationTransformer() {
    }
     ...
     * @throws com.csvanefalk.keytestgen.core.model.ModelGeneratorException
     */
    @Override
    ...
    /**
     * Given an {@link Term} of type {@link de.uka.ilkd.key.logic.op.SortDependingFunction}, with a
