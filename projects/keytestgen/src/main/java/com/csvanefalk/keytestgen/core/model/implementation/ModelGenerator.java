 ...
 * {@link KTGModel}, which constitutes the final representaiton of the model.
 */
public class ModelGenerator implements IModelGenerator {
    ...
    /**
     * generates a {@link KTGModel} for the pathcondition of a single
     ...
     */
    @Override
    public KTGModel generateModel(final IExecutionNode node) throws ModelGeneratorException {
        ...
        try {
             ...
             */
            final KTGModel model = new ModelBuilder().createModel(node, pathCondition);
     ...
     */
    private void instantiateModel(final KTGModel model, final Map<String, Integer> concreteValues) {
