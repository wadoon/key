...
/**
 * Generic frontend that dispatches to the different parsers supported by SMTInterpol.
 * 
...
public class Main {
    ...
    private static void usage() {
        ...
        System.err.println("smtinterpol [-q] [-v] [-t <num>] [-r <num>] [-smt2] [-smt] [-d] [inputfile]");
    ...
    public static void main(String[] param) {
        ...
        exitCode = parser.run(verbosity, timeout, seed, filename);
