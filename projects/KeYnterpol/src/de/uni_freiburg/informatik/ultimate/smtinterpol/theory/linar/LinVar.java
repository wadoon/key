...
public class LinVar implements Comparable<LinVar> {
	...
	/**
	 * Name of the variable.  This is either a SharedTerm for initially
	...
	ArrayList<SharedTerm> m_sharedTerms = new ArrayList<SharedTerm>();
	 ...
	 */
	public LinVar(Object name,boolean isint, int assertionstacklevel) {
		m_name = name;
	...
	/**
	 * Get the flat term from which this non-basic linvar was created.
	 * @throws ClassCastException if this is not an initially non-basic variable.
	 * @return the flat term.
	 */
	public SharedTerm getFlatTerm() {
		return (SharedTerm) m_name;
	}
	
	public Collection<SharedTerm> getSharedTerms() {
		return m_sharedTerms;
	}
