...
public abstract class SharedTerm extends FlatTerm {
	public SharedTerm(ConvertFormula converter) {
		super(converter);
		m_stackLevel = -1;
	}
	...
	public FlatFormula createEquality(SharedTerm other) {
