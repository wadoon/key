...
public class IfThenElseTerm extends SharedTerm implements ClauseDeletionHook {
	FlatFormula mCond;
	SharedTerm mThen, mElse;
	private boolean axiomsCreated;
	private TermVariable m_auxVar;
		
	public IfThenElseTerm(ConvertFormula converter, 
			FlatFormula cond, SharedTerm thenTerm, SharedTerm elseTerm) {
		super(converter);
...
//		createAxioms();
	...
	@Override
	public void clauseDeleted(Clause c, DPLLEngine engine) {
		axiomsCreated = false;
	}
