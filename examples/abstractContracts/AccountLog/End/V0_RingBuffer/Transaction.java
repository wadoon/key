public class Transaction {
	...
	/*@ public normal_behavior
	  ...
	  def transferE3 = \result ==> log.last == (\old(log.last) == log.logRecord.length  - 1 ? 0 : \old(log.last) + 1) && 
               log.logRecord[log.last] == refNum;
	  assignable_abs transferA;
	  def transferA = log.logRecord[(log.last + 1) % log.logRecord.length], log.last, source.balance, destination.balance;
	 @*/
