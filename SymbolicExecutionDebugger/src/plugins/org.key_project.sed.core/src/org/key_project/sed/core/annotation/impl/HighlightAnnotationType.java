 ...
 *
 */
public class HighlightAnnotationType extends AbstractSEAnnotationType {
   /**
    * The ID of this annotation type.
    */
   public static final String TYPE_ID = "org.key_project.sed.core.annotationType.Highlight";
   ...
   public ISEAnnotationLink createLink(ISEAnnotation source, ISENode target) {
      return new HighlightAnnotationLink(source, target);
   }
...
//   }
   ...
   public String saveAnnotationLink(ISEAnnotationLink link) {
      Assert.isTrue(link instanceof HighlightAnnotationLink);
      return "Highlight";
   }
