 ...
 *
 */
public class AlgorithmicDebugBugAnnotationLink extends AbstractSEAnnotationLink {
   
   public AlgorithmicDebugBugAnnotationLink(ISEAnnotation source, ISENode target) {
      super(source, target);
   }
   ...
   public boolean equals( Object o )
   {
     ...
     if ( !(o instanceof AlgorithmicDebugBugAnnotationLink) )
        return false;
     
     AlgorithmicDebugBugAnnotationLink that = (AlgorithmicDebugBugAnnotationLink) o;
