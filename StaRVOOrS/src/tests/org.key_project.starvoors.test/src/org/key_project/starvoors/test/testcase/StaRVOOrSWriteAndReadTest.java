...
public class StaRVOOrSWriteAndReadTest extends AbstractStaRVOOrSTest {
   ...
   protected static StaRVOOrSResult createExpectedHashtableResult() {
      StaRVOOrSMethodContractApplication ma1 = new StaRVOOrSMethodContractApplication("mafile1", 11, 22, 33, 44, "method1", "contract1");
      StaRVOOrSMethodContractApplication ma2 = new StaRVOOrSMethodContractApplication("mafile2", 111, 222, 333, 444, "method2", "contract2");
      ...
      p1.addPath(new StaRVOOrSExecutionPath("true", true, null, null, null, null, null));
      ...
      p2.addPath(new StaRVOOrSExecutionPath("self.h[self.hash_function(key)] = null", true, maa1, null, laa1, null, TerminationKind.EXCEPTIONAL));
      p2.addPath(new StaRVOOrSExecutionPath("!self.h[self.hash_function(key)] = null", false, null, maa1, null, laa1, TerminationKind.NORMAL));
      ...
      p3.addPath(new StaRVOOrSExecutionPath("true", true, null, null, laa1, laa2, TerminationKind.LOOP_BODY));
      StaRVOOrSProof p4 = new StaRVOOrSProof("HashTable[HashTable::hash_function(int)].JML normal_behavior operation contract.0", "TODO:");
      p4.addPath(new StaRVOOrSExecutionPath("val >  -1", true, null, maa1a2, laa1a2, null, null));
      p4.addPath(new StaRVOOrSExecutionPath("val < 0", true, maa1, maa2, laa1a2, null, null));
